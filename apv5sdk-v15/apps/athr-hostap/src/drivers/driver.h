...
struct wpa_driver_ops {
	...
	/**
	 * set_assoc_resp_ie - Set Association Response frame IEs
	 * @ifname: The interface name (main or virtual)
	 * @priv: Private driver interface data
	 ...
	 * Returns: 0 on success, -1 on failure
	 */
	int (*set_assoc_resp_ie)(const char *ifname, void *priv,
				 const u8 *ie, size_t len);

	/**
	 * set_auth_ie - Set Authentication frame IEs
	 * @ifname: The interface name (main or virtual)
	 * @priv: Private driver interface data
	 ...
	 * Returns: 0 on success, -1 on failure
	 */
	 int (*set_auth_ie)(const char *ifname, void *priv,
			    const u8 *ie, size_t len);
