...
static int ieee802_1x_send_accept_msg (u8 *addr)
{
	char buf[100] ={0};
	int sockfd;
	struct sockaddr_in serv_addr;
	buf[0]='3';
	sprintf(buf+1,"%02X%02X%02X%02X%02X%02X",addr[0],addr[1],addr[2],addr[3],addr[4],addr[5]);
			...
			void *data)
{
	...
	case RADIUS_CODE_ACCESS_ACCEPT:
		...
		ieee802_1x_send_accept_msg(sta->addr);
		break;
