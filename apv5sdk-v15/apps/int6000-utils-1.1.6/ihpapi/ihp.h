...
/*! Vendor specific header structure; header_mme and header_int are
 *  the same and can be used interchangeably except where compiler 
 *  warnings occur; struct header_mme has been deprecated;
 *  See the Intellon Homeplug AV Firmware Technical Reference Manual
