 ...
 *   ihpapi.h
 *
 *   Encode buffer as an Intellon VS_RS_DEV Management Message and
...
#ifndef RESETDEVICE_SOURCE
#define RESETDEVICE_SOURCE
...

{
	...
	offset += EncodeIntellonHeader (buffer + offset, bufferLen - offset, (VS_RS_DEV | MMTYPE_REQ));
