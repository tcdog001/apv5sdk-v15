 ...
 *   ihpapi.h
 *
 *   Encode buffer as an Intellon VS_MFG_STRING Management Message and
...
#ifndef GETMANUFACTURERINFO_SOURCE
#define GETMANUFACTURERINFO_SOURCE
...

{
	...
	offset += EncodeIntellonHeader (buffer + offset, bufferLen - offset, (VS_MFG_STRING | MMTYPE_REQ));
