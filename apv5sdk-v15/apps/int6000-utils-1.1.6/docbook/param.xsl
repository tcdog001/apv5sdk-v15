...
<!-- ********************************************************************
     $Id: param.xsl,v 1.2 2008-07-11 16:19:00 cmaier Exp $
     ********************************************************************
...
<xsl:param name="function.parens">1</xsl:param>
...
<xsl:param name="contrib.inline.enabled" select="0"></xsl:param>
...
<xsl:param name="chunk.append" select="0"></xsl:param>
<xsl:param name="highlight.source" select="0"></xsl:param>
<xsl:param name="keep.relative.image.uris" select="0"></xsl:param>
<xsl:param name="default.table.frame" select="0"></xsl:param>
<xsl:param name="html.append" select="0"></xsl:param>
