...
extern struct _code_ controls [CONTROLS];
extern struct _code_ volatilities [VOLATILITIES];
extern struct _code_ actions [ACTIONS];
extern struct _code_ operands [OPERANDS];
extern struct _code_ fields [FIELDS];
extern struct _code_ operators [OPERATORS];
extern struct _code_ states [STATES];
