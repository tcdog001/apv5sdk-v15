...
/*====================================================================*
 *
 *   int6kprobe.c - Intellon Diagnostic Network Probe Utility
 *
...
#include "../int6k/DiagnosticNetworkProbe.c"
...

{
	...
	static const char *optv [] = 
	{
		...
		"Intellon Diagnostic Network Probe Utility",
		"e\tredirect stderr messages to stdout",
		"C\tclear counters after reading",
