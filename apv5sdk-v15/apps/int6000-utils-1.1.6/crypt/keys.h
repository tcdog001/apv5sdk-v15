...
#define VENDOR_MAX 0x00FFFFFF
#define DEVICE_MAX 0x00FFFFFF
...
void MACPasswords (uint32_t vendor, uint32_t device, unsigned devices, unsigned letters, unsigned bunch, unsigned space, flag_t flags);
