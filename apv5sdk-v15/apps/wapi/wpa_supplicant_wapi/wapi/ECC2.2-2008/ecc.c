...
static void sha256_context_init(struct SHA256_CONTEXT *c)
{
...
static void sha256_context_hash(struct SHA256_CONTEXT *cc,
...
static void sha256_context_hashstream(struct SHA256_CONTEXT *c, const void *p, unsigned l)
{
...
static void sha256_context_endstream(struct SHA256_CONTEXT *c, unsigned long l)
{
	unsigned char buf[8];
...
static void sha256_context_digest_int(struct SHA256_CONTEXT *c, MInt *d)
{
	unsigned i;
...
int KTimesPoint(unsigned int *piPrivateKey,int *piLenOfPriKey,
				 Point *poTempPublicKey, int iKeyBitLen1,Point *poAddPoint, int iKeyBitLen2)
{
	...
	iKeyBitLen1 = iKeyBitLen1;
	iKeyBitLen2 = iKeyBitLen2;
