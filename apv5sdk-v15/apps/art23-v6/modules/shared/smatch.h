 ...
 */
extern int Scompare(char *text1, char *text2);
 ...
 * Returns > 0 if the second string comes first in alphabetical order.
 */
extern int ScompareBackwards(char *text1, char *text2);
 ...
 */
extern int Sequal(char *text1, char *text2);


/*
 * Copies the source string to the destination.
 */
extern void Scopy(char *destination, char *source);


extern void Sdestroy(char *text);


/*
 * Creates and copies an existing string.
 */
extern char *Sduplicate(char *source);


/*
 * Makes the string empty.
 */
extern void Sempty(char *text);
 ...
 */
extern void Stolower(char *destination, char *source);
 ...
 */
extern void Stoupper(char *destination, char *source);


/*
 * Truncates the string to the specified length.
 */
extern void Struncate(char *text, int length);


/*
 * Appends the second string to the end of the first.
 */
extern void Sappend(char *text1, char *text2);


/*
 * Appends the character the end of the text.
 */
extern void SappendChar(char *text1, char char1);


/*
 * Removes blanks from both ends of the string.
 */
extern void Strim(char *source);
 ...
 */
extern int Ssub(char *sub, char *line);
 ...
 */
extern int Smatch(char *text1, char *text2);
 ...
 * Otherwise returns -1.
 */
extern int Sisoneof(char *separator, char character);
 ...
 * Returns the number of words found.  
 */
extern int ScountWords(char *text, 
 ...
 */
extern int SwordsNoNest(char *text,
    int condense, char *separator, char *grouper, char *escaper, char **word);
 ...
 */
extern int SextractNoNest(char *text,
 ...
 * the same parsing rules.
 */
extern int SblankWord(char *text,
    int condense, char *separator, char *grouper, char *escaper, int position);
 ...
 * the same parsing rules.
 */
extern int SblankSeparator(char *text,
    char *separator, char *grouper, char *escaper, int position);
    

extern int SnoBlank(char *result, char *source);


extern int Sgreater(char *string1, char *string2);
...
//
extern int StrimEnd(char *buffer);
