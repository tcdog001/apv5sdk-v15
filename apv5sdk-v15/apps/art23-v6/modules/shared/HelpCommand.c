...
// "ACI $Id: //depot/sw/branches/narthal_mar2011/dk/mdk/shared/HelpCommand.c#1 $, $Header: //depot/sw/branches/narthal_mar2011/dk/mdk/shared/HelpCommand.c#1 $"
...
static int HelpShowDefault=HelpShowAll;
...
void HelpParameterSplice(struct _ParameterList *list)
{
...
void HelpCommand(struct _ParameterList *inlist, int nlist)
{
	int ip,nparam;
	int iv, nvalue;
	int code;
