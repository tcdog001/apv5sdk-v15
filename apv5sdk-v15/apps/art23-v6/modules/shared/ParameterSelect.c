...
int ParameterTypeValid(char type)
{
	switch(type)
	{
		case 'a':
...
void ParameterHelpLine(struct _ParameterList *cl, char *buffer, int max)
{
	int lc,nc;
...
//
void ParameterHelpSingle(struct _ParameterList *cl, void (*print)(char *buffer))
{
	int it, is;
	int lc, nc;
...
//
void ParameterHelp(struct _ParameterList *cl, int nl, void (*print)(char *buffer))
{
    int ip;
...
//
int ParameterValueMaximum(struct _ParameterList *cl)
{
...
//
//
int ParameterSelectIndexArray(char *buffer, struct _ParameterList *cl, int nl, int *xindex, int *yindex, int *zindex)
{
    int il, it, ic, ip;
    int good;
    int bl;
...
int ParameterSelectIndex(char *buffer, struct _ParameterList *cl, int nl)
{
	int it, jt, kt;
...
int ParameterSelect(char *buffer, struct _ParameterList *cl, int nl)
{
    int index;
...
char *ParameterName(int code, struct _ParameterList *cl, int nl)
{
    int il;
	//
