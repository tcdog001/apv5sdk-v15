...
//
static void Ar5416TxDescriptorSetup(void *block, 
...
//
static void Ar5416TxDescriptorReset(void *block)
{  
	struct Ar5416TxDescriptor *dr=(struct Ar5416TxDescriptor *)block;
	//
...
void Ar5416TxDescriptorSelect()
{
	...
	//
	TxDescriptorSizeFunction(Ar5416TxDescriptorSize);
	TxDescriptorSetupFunction(Ar5416TxDescriptorSetup);
	TxDescriptorResetFunction(Ar5416TxDescriptorReset);
	TxDescriptorPrintFunction(Ar5416TxDescriptorPrint);
    
	TxDescriptorLinkPtrFunction(Ar5416TxDescriptorLinkPtr);
    TxDescriptorBufPtrFunction(Ar5416TxDescriptorBufPtr);
    TxDescriptorBufLenFunction(Ar5416TxDescriptorBufLen);
    TxDescriptorDataLenFunction(Ar5416TxDescriptorFrameLength);

    TxDescriptorDoneFunction(Ar5416TxDescriptorDone);
    TxDescriptorMoreAggFunction(Ar5416TxDescriptorMoreAgg);
    TxDescriptorAggregateFunction(Ar5416TxDescriptorAggregate);
    TxDescriptorTxRateFunction(Ar5416TxDescriptorTxRate);
    TxDescriptorSendTimestampFunction(Ar5416TxDescriptorSendTimestamp);
    TxDescriptorIntReqFunction(Ar5416TxDescriptorIntReq);
    TxDescriptorRssiCombinedFunction(Ar5416TxDescriptorRssiCombined);
    TxDescriptorRssiAnt00Function(Ar5416TxDescriptorRssiAnt00);
    TxDescriptorRssiAnt01Function(Ar5416TxDescriptorRssiAnt01);
    TxDescriptorRssiAnt10Function(Ar5416TxDescriptorRssiAnt10);
    TxDescriptorRssiAnt11Function(Ar5416TxDescriptorRssiAnt11);
    TxDescriptorFrameTxOkFunction(Ar5416TxDescriptorFrameTxOk);

    TxDescriptorBaStatusFunction(Ar5416TxDescriptorBaStatus);
    TxDescriptorAggLengthFunction(Ar5416TxDescriptorAggLength);
    TxDescriptorBaBitmapLowFunction(Ar5416TxDescriptorBaBitmapLow);
    TxDescriptorBaBitmapHighFunction(Ar5416TxDescriptorBaBitmapHigh);
    TxDescriptorFifoUnderrunFunction(Ar5416TxDescriptorFifoUnderrun);
    TxDescriptorExcessiveRetriesFunction(Ar5416TxDescriptorExcessiveRetries);
    TxDescriptorRtsFailCountFunction(Ar5416TxDescriptorRtsFailCount);
    TxDescriptorDataFailCountFunction(Ar5416TxDescriptorDataFailCount);

	//
	// functins that set fields in the descriptor
	//
    TxDescriptorLinkPtrSetFunction(Ar5416TxDescriptorLinkPtrSet);
    TxDescriptorTxRateSetFunction(Ar5416TxDescriptorTxRateSet);
