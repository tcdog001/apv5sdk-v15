...
extern A_INT32 Ar9300MacAdressSet(unsigned char *mac);
...
extern A_INT32 Ar9300TempSlopeSet(int value, int iBand);
extern A_INT32 Ar9300VoltSlopeSet(int value, int iBand);
extern A_INT32 Ar9300TempSlopeLowSet(int value);
extern A_INT32 Ar9300TempSlopeHighSet(int value);
...
extern A_INT32 Ar9300noiseFloorThreshChSet(int *value, int ix, int iy, int iz, int num, int iBand);
...
//
extern int Ar9300NoiseFloorSet(int frequency, int ichain, int nf);
extern int Ar9300NoiseFloorPowerSet(int frequency, int ichain, int nfpower);
