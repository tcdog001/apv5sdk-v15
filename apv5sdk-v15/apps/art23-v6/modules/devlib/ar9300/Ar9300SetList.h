...
enum
{
    ...
    Ar9300SetEeprom2GHzNoiseFloorThreshold,
...
//    Ar9300SetEeprom2GHzCalibrationData,
    ...
    Ar9300SetEeprom5GHzNoiseFloorThreshold,
...
#define AR9300_SET_2GHZ_TEMPERATURE_SLOPE {Ar9300SetEeprom2GHzTemperatureSlope,{Ar9300Eeprom2GHzTemperatureSlope,"tempSlope2g","TemperatureSlope2g"},"slope used in temperature compensation algorithm",'d',0,1,1,1,\
...
#define AR9300_SET_2GHZ_NOISE_FLOOR_THRESHOLD {Ar9300SetEeprom2GHzNoiseFloorThreshold,{Ar9300Eeprom2GHzNoiseFloorThreshold,"NoiseFloorThreshCh2g",0},"noise floor threshold",'d',0,OSPREY_MAX_CHAINS,1,1,\
	&SignedByteMinimum,&SignedByteMaximum,&SignedByteDefault,0,0}
...
#define AR9300_SET_5GHZ_TEMPERATURE_SLOPE {Ar9300SetEeprom5GHzTemperatureSlope,{Ar9300Eeprom5GHzTemperatureSlope,"tempSlope5g","TemperatureSlope5g"},"slope used at 5500 MHz in temperature compensation algorithm",'d',0,1,1,1,\
	&SignedByteMinimum,&SignedByteMaximum,&SignedByteDefault,0,0}

#define AR9300_SET_5GHZ_TEMPERATURE_SLOPE_LOW {Ar9300SetEeprom5GHzTemperatureSlopeLow,{Ar9300Eeprom5GHzTemperatureSlopeLow,"tempSlopeLow5g","TemperatureSlopeLow5g"},"slope used at 5180 MHz in temperature compensation algorithm",'d',0,1,1,1,\
	&SignedByteMinimum,&SignedByteMaximum,&SignedByteDefault,0,0}

#define AR9300_SET_5GHZ_TEMPERATURE_SLOPE_HIGH {Ar9300SetEeprom5GHzTemperatureSlopeHigh,{Ar9300Eeprom5GHzTemperatureSlopeHigh,"tempSlopeHigh5g","TemperatureSlopeHigh5g"},"slope used at 5785 MHz in temperature compensation algorithm",'d',0,1,1,1,\
	&SignedByteMinimum,&SignedByteMaximum,&SignedByteDefault,0,0}
...
#define AR9300_SET_5GHZ_NOISE_FLOOR_THRESHOLD {Ar9300SetEeprom5GHzNoiseFloorThreshold,{Ar9300Eeprom5GHzNoiseFloorThreshold,"NoiseFloorThreshCh5g",0},"noise floor threshold",'d',0,OSPREY_MAX_CHAINS,1,1,\
	&SignedByteMinimum,&SignedByteMaximum,&SignedByteDefault,0,0}
