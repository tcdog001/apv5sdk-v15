...
void AR9300PAPDDebugPrint(struct ath_hal *ah)
{
    ...
    if (AR_SREV_POSEIDON(ah)) {
        ...
        printf("BB_paprd_trainer_cntl2.cf_paprd_init_rx_bb_gain=0x%x\n", temp);
        ...
        printf("    paprd_train_samples_cnt     = 0x%08x\n", temp);
    } else {
        //FieldRead("BB_paprd_trainer_cntl1.cf_paprd_lb_skip", &temp);
        temp =
    ...
    printf("    BB_paprd_ctrl0_b0.paprd_enable_0     = 0x%08x\n", temp);
    if (!AR_SREV_POSEIDON(ah)) {
        ...
        printf("    BB_paprd_ctrl0_b1.paprd_enable_1     = 0x%08x\n", temp);
        ...
        printf("    BB_paprd_ctrl0_b2.paprd_enable_2     = 0x%08x\n", temp);
    }
    ...
    printf("txbb1dbgain=0x%x, txbb6dbgain=0x%x, txmxrgain=0x%x\n", txbb1dbgain,
        txbb6dbgain, txmxrgain);
    printf("padrvgnA=0x%x, padrvgnB=0x%x\n", padrvgnA, padrvgnB);
    printf("padrvgnC=0x%x, padrvgnD=0x%x\n", padrvgnC, padrvgnD);

    /*
     * FieldWrite(
     *     "BB_paprd_pre_post_scale_0_b0.paprd_pre_post_scaling_0_0", 261376);
     */
    printf("BB_paprd_pre_post_scale_0_b0= 0x%08x\n", OS_REG_READ(ah,
            AR_PHY_PAPRD_PRE_POST_SCALE_0_B0));
    printf("BB_paprd_pre_post_scale_1_b0= 0x%08x\n", OS_REG_READ(ah,
            AR_PHY_PAPRD_PRE_POST_SCALE_1_B0));
    printf("BB_paprd_pre_post_scale_2_b0= 0x%08x\n", OS_REG_READ(ah,
            AR_PHY_PAPRD_PRE_POST_SCALE_2_B0));
    printf("BB_paprd_pre_post_scale_3_b0= 0x%08x\n", OS_REG_READ(ah,
            AR_PHY_PAPRD_PRE_POST_SCALE_3_B0));
    printf("BB_paprd_pre_post_scale_4_b0= 0x%08x\n", OS_REG_READ(ah,
            AR_PHY_PAPRD_PRE_POST_SCALE_4_B0));
    printf("BB_paprd_pre_post_scale_5_b0= 0x%08x\n", OS_REG_READ(ah,
            AR_PHY_PAPRD_PRE_POST_SCALE_5_B0));
    printf("BB_paprd_pre_post_scale_6_b0= 0x%08x\n", OS_REG_READ(ah,
            AR_PHY_PAPRD_PRE_POST_SCALE_6_B0));
    printf("BB_paprd_pre_post_scale_7_b0= 0x%08x\n", OS_REG_READ(ah,
...
void ar9300PAPRDTestPrints(struct ath_hal *ah)
{
    ...
    //printf("=====ar9300PAPRDTestPrints end=======\n");
    reg = AR_PHY_PAPRD_MEM_TAB_B1;
