...
{	
	...
	ar7240_reg_wr (AR7240_GPIO_FUNC, (ar7240_reg_rd(AR7240_GPIO_FUNC) & (~(1 << 4))));
	ar7240_reg_wr (AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | (1 << 14)));
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) & (~(1 << 14))));
