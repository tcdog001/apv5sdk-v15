...
static void
ath_spi_read_unique_id(void)
{
	u32 dummy_4= 0x77777777;
    u32 bit63_32= 0x77777777;
    u32 bit31_0= 0x77777777;

	ar7240_reg_wr_nf(AR7240_SPI_WRITE, AR7240_SPI_CS_DIS);
	ar7240_spi_bit_banger(AR7240_SPI_CMD_RDUNIQUEID);
	ar7240_spi_delay_8();
	ar7240_spi_delay_8();
	ar7240_spi_delay_8();
    ar7240_spi_delay_8();
	dummy_4 = ar7240_reg_rd(AR7240_SPI_RD_STATUS);
	ar7240_spi_delay_8();
	ar7240_spi_delay_8();
	ar7240_spi_delay_8();
    ar7240_spi_delay_8();
	bit63_32 = ar7240_reg_rd(AR7240_SPI_RD_STATUS);
	ar7240_spi_delay_8();
	ar7240_spi_delay_8();
	ar7240_spi_delay_8();
    ar7240_spi_delay_8();
	bit31_0 = ar7240_reg_rd(AR7240_SPI_RD_STATUS);

	printf("dummy_4 0x%04x,, unique id bit63_32 0x%04x,, unique id bit31_0 0x%04x,\n",
		dummy_4, bit63_32,bit31_0);
    ar7240_spi_go();
	printf("dummy_4 0x%04x,, unique id bit63_32 0x%04x,, unique id bit31_0 0x%04x,\n",
		dummy_4, bit63_32,bit31_0);
