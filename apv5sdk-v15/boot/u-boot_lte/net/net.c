...
NetLoop(proto_t protocol)
{
...
#ifdef CONFIG_NET_MULTI
    char *s;  /*modify by zhangsiyu for eth1 problem 2014-9-29*/
	NetRestarted = 0;
	NetDevExists = 0;   
#endif
	...
	setenv("ethact", "eth1");
#else
  /*Begin:modify by zhangsiyu for eth1 problem 2014-9-29*/
    if ((s = getenv ("ethact")) == NULL) {
          setenv("ethact", "eth0");
    }
   /*End:modify by zhangsiyu for eth1 problem 2014-9-29*/      
#endif
	eth_set_current();
#endif
	if (eth_init(bd) < 0) {
