...
#define ATH_FLASH_SIZE_16MB          (16*1024*1024) /*add by zhangsiyu for ltefi 2014-9-29*/
...
/*Begin:modify by zhangsiyu for ltefi 2014-9-29*/
...
/*End:modify by zhangsiyu for ltefi 2014-9-29*/
...
#endif
#if defined ( AE1000_OS )
static struct mtd_partition allflash_partitions[]= {	
	{
	.name           = "bigkernel",
	.size           = 896 * 1024,
	.offset         = 320 * 1024,
...
#else
//Autelan wangyu add the pc018 mtd_partition 2011-05-27
static struct mtd_partition allflash_partitions[]= {	
	{
	.name           = "bigkernel",
	.size           = 1088 * 1024,
...
//Autelan wangyu add end
#endif
//Autelan wangyu add the xj9344 mtd_partition 2011-09-27
#if defined ( XJ9344 )|| defined ( XH9344  )
static struct mtd_partition xj9344_allflash_partitions[]= {	
	{
	.name		= "all_flash",
	.size		= 16 * 1024 * 1024,
	.offset		= 0,
...
//			#ifdef XJ9344
			#if defined ( XJ9344 )|| defined ( XH9344 )
			add_mtd_partitions(mtd, &xj9344_allflash_partitions, 1); //Autelan wangyu add the xj9344 mtd_partition 2011-09-27
			//Autelan wangyu add the xj9344 mtd_partition 2011-09-27
			#else
			add_mtd_partitions(mtd, &allflash_partitions, 3); //Autelan wangyu add the pc018 mtd_partition 2011-05-27
			#endif
		} else {
