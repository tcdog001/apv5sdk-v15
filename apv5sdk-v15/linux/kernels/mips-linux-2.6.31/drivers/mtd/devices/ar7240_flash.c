...
#endif
//Autelan wangyu add the xj9344 mtd_partition 2012-11-15
...
//Autelan wangyu add the xj9344 mtd_partition 2012-11-15
			#if defined ( AE5000ENT )
			add_mtd_partitions(mtd, &xj9344_allflash_partitions, 3); //Autelan wangyu add the xj9344 mtd_partition 2011-09-27
			#endif
//Autelan wangyu add the xj9344 mtd_partition 2012-11-15 end
		} else {
