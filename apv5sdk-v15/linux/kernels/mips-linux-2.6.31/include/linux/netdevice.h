...
struct net_device_stats
{
	...
	/*Begin:Added by duanmingzhe for multicast and retry count*/
	unsigned long	rx_retry_packets;
	unsigned long	tx_retry_packets;
	unsigned long	rx_retry_bytes;
	unsigned long	tx_retry_bytes;

	/*zhaoyang modify for retry packet count ISSUES-665*/
	unsigned long	rx_retry_mgmt_packets;
	unsigned long	tx_retry_mgmt_packets;
	unsigned long	rx_retry_mgmt_bytes;
	unsigned long	tx_retry_mgmt_bytes;
	/*zhaoyang modify end*/
	...
	/*Begin:Added by duanmingzhe for multicast and retry count*/
	/*Begin:added by pengruofeng for counting of error 2011-5-9*/
	unsigned long	rx_error_frames;		/* bad frames received		*/
	/*End:added by pengruofeng for counting of error 2011-5-9*/
};
...
typedef struct
{
	...
	u_int32_t first_msgtype;
	u_int32_t second_time;
	u_int32_t second_msgtype;
	u_int32_t third_time;
	u_int32_t third_msgtype;
} capwap_record;
