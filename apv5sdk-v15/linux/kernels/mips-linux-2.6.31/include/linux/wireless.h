...
#define SIOCGIWPMKSA	0x8B37		/* PMKSA cache operation */


#define SIOCSIWVAPRATEFRAME 0x8B38  
#define SIOCGIWVAPRATEFRAME 0x8B39  /*for getting statistics of every frame by the rate*/


#define SIOCSIWNIRATEFRAME 0x8B3A  
#define SIOCGIWNIRATEFRAME 0x8B3B  /*for getting statistics of every frame by the rate*/
...
/*pengruofeng add start wids 2011-5-31*/
#define IWEVWIDSALERM 0x8c0a
...
/*suzhaoyu add for change disassoc message*/
#define IWEVSTALV 0x8C0D
/*suzhaoyu add end*/
...
#define IW_MAX_FREQUENCIES	34  // modified by chenming for PCAPVXN-103
/* Note : if you have something like 80 frequencies,
 * don't increase this constant and don't fill the frequency list.
 * The user will be able to set by channel anyway... */

/* Maximum bit rates in the range struct */
#define IW_MAX_BITRATES		36  /*modified by chenming for rate display*/

/* Maximum tx powers in the range struct */
#define IW_MAX_TXPOWER		32  /*modified by chenming-issue num PCAPVXN-78*/
...
/*Begin:add by zhaoej for guangdong mobile vap_rssi 2013-02-22 */
#ifndef RSSI_RANGE_NUM
#define RSSI_RANGE_NUM  17
#endif
    struct rssi_stats   vap_rssi_stats[RSSI_RANGE_NUM];
/*End:add by zhaoej for guangdong mobile vap_rssi 2013-02-22 */
};
