...
extern int pro_file_sche_flag; //added by duanmingzhe for kernel abnormal reboot log
extern int create_flag_file(char *, char *); //added by duanmingzhe for  kernel abnormal reboot log
...
#endif
		/*wangyu add end */
//zhengkun  move the action of write log to panic();
#if 0
        /*Begin:added by duanmingzhe for kernel abnormal reboot log*/
        pro_file_sche_flag = 1;
        create_flag_file("/jffs/kernel_reboot_log", "kernel panic\n");
	    create_flag_file("/jffs/sysrebootflag", NULL);
        /*End:added by duanmingzhe for kernel abnormal reboot log*/
#endif
	console_verbose();
	...
	die_if_kernel("FP exception in kernel code", regs);
		...
		printk("ATH-2X8: %s(%d): FP Error\n", __func__, __LINE__);
             /*<Begin : caizhibang add  for kes 2013-03-05 */
              if(kes_traps_print_handle)
              {
                   kes_traps_print_handle("ATH-2X8: %s(%d): FP Error\n", __func__, __LINE__);
              }
              /*End : caizhibang add  for kes 2013-03-05 >*/
