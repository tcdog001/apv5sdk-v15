...
static const struct iw_ioctl_description standard_ioctl[] = {
    ...
    [SIOCGIWPMKSA - SIOCIWFIRST] = {
        .header_type    = IW_HEADER_TYPE_POINT,
    },

    [SIOCSIWVAPRATEFRAME- SIOCIWFIRST] = {
        .header_type    = IW_HEADER_TYPE_POINT,
    },
    
    [SIOCGIWVAPRATEFRAME- SIOCIWFIRST] = {
        .header_type    = IW_HEADER_TYPE_POINT,
        .token_size = 1,
        .min_tokens = sizeof(struct iw_vap_rate_frame_req),
        .max_tokens = sizeof(struct iw_vap_rate_frame_req),
    },

    [SIOCGIWNIRATEFRAME- SIOCIWFIRST] = {
        .header_type    = IW_HEADER_TYPE_POINT,
        .token_size = 1,
        .min_tokens = sizeof(struct iw_ni_rate_frame_req),
        .max_tokens = sizeof(struct iw_ni_rate_frame_req),
    },
...
static const struct iw_ioctl_description standard_event[] = {
	...
	/*pengruofeng add start 2011-5-31*/
	[IWEVWIDSALERM	- IWEVFIRST] = {
		.header_type	= IW_HEADER_TYPE_POINT,
		.token_size = 1,
		.max_tokens = 1024,
	},	
