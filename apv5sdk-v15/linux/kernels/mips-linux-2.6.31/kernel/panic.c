...
#include <linux/nmi.h>
#include <linux/dmi.h>
//wangyu add for the pro_ctl_mod watchdog 2011-05-27
int (*stop_ap2400_watchdog)(void);
struct timer_list dog_timer;
EXPORT_SYMBOL(dog_timer);
EXPORT_SYMBOL(stop_ap2400_watchdog);
//wangyu add end
...
int (*turn_up_link_led)(void) = NULL;
int (*turn_down_link_led)(void)= NULL;
int (*turn_up_2G_led)(void)= NULL;
int (*turn_down_2G_led)(void)= NULL;
int (*turn_up_5G_led)(void)= NULL;
int (*turn_down_5G_led)(void)= NULL;


EXPORT_SYMBOL(turn_up_link_led);
EXPORT_SYMBOL(turn_down_link_led);
EXPORT_SYMBOL(turn_up_2G_led);
EXPORT_SYMBOL(turn_down_2G_led);
EXPORT_SYMBOL(turn_up_5G_led);
EXPORT_SYMBOL(turn_down_5G_led);

/*end:wangyu add for the gpio operation*/
/*zhengkun add 2012-6-4*/
...
NORET_TYPE void panic(const char * fmt, ...)
{
	...
	long i;
        ...
        create_flag_file("/jffs/kernel_reboot_log", "kernel panic\n");
	...
	//wangyu add WATCHDOG for apv5
	printk("now stop the watchdog\n"); //ghy add for watchdog
	...
	if(stop_ap2400_watchdog){
		stop_ap2400_watchdog();
	}
	del_timer(&dog_timer);
