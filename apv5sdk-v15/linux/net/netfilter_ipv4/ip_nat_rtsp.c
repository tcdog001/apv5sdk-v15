 ...
 * All rights reserved
 *
 * Author: Ken Zhu    kenzh@wicresoft.com    2009/1/14
 */
    ...
    case pb_range:
        for (loport = prtspexp->loport; loport != 0; loport += 2) /* XXX: improper wrap? */
        {
            ...
            if (ip_conntrack_expect_related(exp) == 0)
            {
				...
				rtcp_exp = ip_conntrack_expect_alloc(ct);
				...
				rtcp_exp->tuple.dst.u.udp.port = htons(loport + 1);
