...
route_forward_setup()
{
    ...
    xml_bnet_sroute=`config_setoption "$xml_bnet_sroute" rtip2 "$rtip2"`
    ...
    xml_bnet_sroute=`config_setoption "$xml_bnet_sroute" rtip3 "$rtip3"`
    ...
    xml_bnet_sroute=`config_setoption "$xml_bnet_sroute" rtip4 "$rtip4"`
