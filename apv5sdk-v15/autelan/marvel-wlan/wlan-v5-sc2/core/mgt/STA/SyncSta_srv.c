/*
*                Copyright 2002-2011, Marvell Semiconductor, Inc.
...
{ 
    ...
    else if(vStaInfo_p->ScanParams.ScanType == SCAN_PASSIVE)
    {
        WlLogPrint(MARVEL_DEBUG_DEBUG, __func__,"Scanning channel:%d\n",currentChnl);
    }
