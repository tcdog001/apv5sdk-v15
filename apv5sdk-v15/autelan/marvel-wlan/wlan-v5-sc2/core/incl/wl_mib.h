...
typedef struct MIB_802DOT11_s
{
	...
	UINT8 *mib_rxAntenna;
	UINT8 *mib_txAntenna;
	UINT8 *mib_rxchainmask;//added by pengdecai
    UINT8 *mib_txchainmask; //added by pengdecai
...
#define MAX_WDS_PORT   6
	...
	UINT8 *mib_AmpduTx;
	UINT8 *mib_rifsQNum;
	UINT8 *mib_MaxAmpduLen; 
	UINT8 *mib_MaxAmpduNum; 
	UINT16 *mib_MaxPacketLifetime;
#endif
...
/************** zhouke add for rate_G not contain rate_B ************/
//#define MRVL_BSSBASICRATEMASK_G		0x02AF	/* Default for G mode: 1, 2, 5.5, 11, 6, 12, 24 Mbps */
#define MRVL_BSSBASICRATEMASK_G			0x02A0	/* Default for G mode: 6, 12, 24 Mbps */
...
#endif
//#define MINTXPOWER 11 /* min power 11 db */

#define MINTXPOWER 0 /* min power 0 db */ //modified MINTXPOWER=11 to MINTXPOWER=0 by pengdecai
#define MAXPOWER 27 /* max power 27 db */ //added by pengdecai
