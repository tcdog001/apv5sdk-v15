...
/********** zhouke add  **********/
#define IEEE80211_STATUS_NO_HT                  27
/************* end *************/
...
#define	IEEE_ETHERTYPE_PRE_PAE	0x88c7		/* pre auth eap for wpa2 thinap */
#define IEEE_ETHERTYPE_WAI  0x88B4
#else
#define IEEE_QOS_CTL_AMSDU 0x80
#define	IEEE_ETHERTYPE_PAE	0x8e88		/* EAPOL PAE/802.1x */
#define	IEEE_ETHERTYPE_PRE_PAE	0xc788		/* pre auth eap for wpa2 thinap */
#define IEEE_ETHERTYPE_WAI  0xB488
#endif
