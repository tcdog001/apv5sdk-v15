...
#define CONSECTXFAILLIMIT		200			//Default value. Consecutive tx fail cnt > limit to kick out client. Zero to disable.
#define _CONSECTXFAILLIMIT		10			//Use this when enabling mcastproxy with mib_consectxfaillimit value set as default
#ifdef QOS_FEATURE
