...
#define HostCmd_CMD_SET_WAPI_IE             0x1159
#define HostCmd_CMD_GET_CONSEC_TXFAIL_ADDR	0x1160			
#define HostCmd_CMD_SET_TXFAILLIMIT			0x1161			
#define HostCmd_CMD_GET_TXFAILLIMIT			0x1162	

#define HostCmd_CMD_SET_MAX_PACKET_LIFETIME 	0x1163 
// The test command.
...
typedef PACK_START struct tagHostCmd_FW_SET_PACKET_LIFETIME
{
	FWCmdHdr	CmdHdr;
	UINT16		max_lifetime;    
} PACK_END HostCmd_FW_SET_PACKET_LIFETIME, *PHostCmd_FW_SET_PACKET_LIFETIME;
