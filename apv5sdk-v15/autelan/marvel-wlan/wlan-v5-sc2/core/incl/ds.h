...
#ifdef SOC_W8764
extern int ieee80211_input(struct net_device *dev, struct sk_buff *skb, u_int32_t rssi, u_int32_t rssiPaths, u_int8_t ampdu_qos, u_int32_t status, u_int8_t rxRate);
#else
...
extern void user_stations_info(struct net_device *netdev, struct sk_buff *skb);
