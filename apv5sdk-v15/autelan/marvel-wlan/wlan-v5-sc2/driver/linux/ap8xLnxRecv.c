...
#endif
{
...
#endif
    {
        ...
        //wlpptr->netDevStats.rx_packets++;         //zhouke add,rx_packets is data packet;
#ifdef AMPDU_SUPPORT
...
#ifdef SOC_W8764
            work_done+=ieee80211_input(netdev, pRxSkBuff,rssi,rssi_paths,ampdu_qos,status,rxRate);
#else
...
#else
#ifdef SOC_W8764
        work_done+=ieee80211_input(netdev, pRxSkBuff,rssi,rssi_paths, status, rxRate);
#else
