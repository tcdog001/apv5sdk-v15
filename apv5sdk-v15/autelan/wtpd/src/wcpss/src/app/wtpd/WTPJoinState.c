...
CWBool CWGetHostIP(char *hostip)
{
	...
	autelan_sprintf(cmd_str, "/sbin/ifconfig default | awk -F \" \" '/inet addr/ {print $2}' | awk -F \":\" '{print $2}'");
