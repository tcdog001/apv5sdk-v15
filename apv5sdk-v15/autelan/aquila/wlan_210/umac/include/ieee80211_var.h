...
extern u_int32_t ping_test_len;
extern u_int32_t ping_timeout_threshod;
...
extern u_int16_t txqprint;
extern u_int16_t printdevid;
...
extern u_int32_t tunnel_qos_correction;
/*End: added by wangjia for 802.11 tunnel QoS correction. 2012-12-21. */

extern u_int32_t rx_hp_cnt;
extern u_int32_t rx_lp_cnt;
...
/*lyb add start*/
extern u_int32_t noise_sched;
/*lyb add end*/
/*yanggs transplant end*/
/*yanggs transplant for cts*/
extern u_int32_t cts_duration;
/*yanggs transplant end*/
...
extern u_int32_t autelan_drv_monitor_enable;//driver monitor switch <zej>
...
struct autelan_wmm {
	...
	unsigned char vlan_ingress_priority[4];
	unsigned char vlan_egress_priority[8];
	unsigned char tos_ingress_priority[4];
	unsigned char tos_egress_priority[16];
...
u_int32_t vap_channelchangecount;
...
/* multiple thread safe */
    ...
    u_int32_t                         iv_nrates;
    u_int32_t                         iv_ntries;
#define TATAL_N_COUNT(nrates)        ( ((nrates) & 0xFF) + (((nrates)>>8) & 0xFF) + (((nrates)>>16) & 0xFF) + (((nrates)>>24) & 0xFF) )
#define TATAL_N_TIME(nrates)        ( ((nrates)&0x01)? ((((nrates)>>8)&0x01)? ((((nrates)>>16)&0x01)? ((((nrates)>>24)&0x01)? 4: 3): 2): 1) :0 )
#define GET_N_TRIES(ntries, n)      ((ntries)>>(8*(n)) & 0xFF)
    ...
    ieee80211_node_list_t             iv_node_list;
...
#define IBSS_RSSI_CLASS_MAX 7
    ...
    /*yanggs transplant for cts*/    
	/*lyb add start*/
	struct timer_list	send_null_data_timer;
	/*lyb add end*/
    /*yanggs transplant end*/
...
#define IEEE80211_DEAUTH_INTERVAL_MAX   60 /* 1 minute max */ 
    ...
    struct ieee80211_node *aute_ping_test_ni_last;
