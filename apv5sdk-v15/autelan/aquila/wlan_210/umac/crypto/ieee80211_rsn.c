...
ieee80211_set_keymapping_key(struct ieee80211vap *vap, ieee80211_keyval *kval)
{
	...
	/*AUTELAN-Added-Begin:Fixed the bug of sometime staton can not assoc to AP, in IEEE80211_VERIFY_ADDR ni_bssid is NULL*/
        IEEE80211_ADDR_COPY(ni->ni_bssid, vap->iv_bss->ni_bssid);
        /*AUTELAN-Added-End:Fixed the bug of sometime staton can not assoc to AP, in IEEE80211_VERIFY_ADDR ni_bssid is NULL*/
    }
