...
ieee80211_wme_initparams_locked(struct ieee80211vap *vap)
{
    ...
    for (i = 0; i < WME_NUM_AC; i++) {
        ...
        /*Begin: yanggs transplant for saving wmm params 2013-02-20 TDDEVA-266 */
        if(wme->wme_wmeChanParams.cap_wmeParams[i].wmep_logcwmin == 0 && wme->wme_wmeChanParams.cap_wmeParams[i].wmep_logcwmax == 0)
        {
        /*End: yanggs transplant for saving wmm params 2013-02-20 TDDEVA-266*/
        	if (vap->iv_opmode == IEEE80211_M_HOSTAP) {
