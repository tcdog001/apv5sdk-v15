                         ...
                         const void *optie, const size_t  optielen)
{
    ...
    *(u_int16_t *)frm = htole16(capinfo);
    ...
    vap->iv_stats.is_tx_proberesp++;    /*Add  by zhaoenjuan for proresp 2013-03-12*/
...
ieee80211_recv_probereq(struct ieee80211_node *ni, wbuf_t wbuf, int subtype)
{
    ...
    /*<Begin:caizhibang modify for probe request 2013-04-09*/
#if 0
	...
	/*zhaoyang1 add end*/
    #endif
    /*End:caizhibang modify for probe request 2013-04-09>*/
