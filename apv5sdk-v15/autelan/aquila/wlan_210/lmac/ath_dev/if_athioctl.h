...
struct ath_11n_stats {
	...
	u_int32_t   aute_tx_schedule;    /*tx schedule do something zhaoenjuan*/
...
/*Begin:added by zhaoenjuan for wifi  tx statistic 2013-10-24*/
    u_int64_t   ast_be_xmit_bytes; 
    u_int64_t   ast_tx_mgmt_bytes;
/*End:added by zhaoenjuan for wifi  tx statistic 2013-10-24*/
    ...
    u_int32_t   ast_txq_noaggr_packets[16];     /* perq no-aggr packets sent on the interface for each category */  //add by zhaoenjuan
