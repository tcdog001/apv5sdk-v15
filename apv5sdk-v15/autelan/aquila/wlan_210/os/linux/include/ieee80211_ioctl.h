...
#define SET_SAFE1           7
	...
	u_int8_t        ni_pce_ipaddr[4];  //pce address
	u_int8_t        ni_safe_ipaddr[4];
	u_int8_t		ni_safe1_ipaddr[4]; //record the portal server IP addr 
};
/*zhaoyang modify end*/

struct ieee80211_autelan_addr
{
    u_int8_t is_use;
    u_int8_t if_name[16];
    u_int32_t cpe_addr;
    u_int32_t portal_addr;
	u_int32_t safe_addr;
	u_int32_t safe1_addr;
};
...
struct ieee80211req_scan_result {
	...
	//u_int8_t	isr_rates[IEEE80211_RATE_MAXSIZE];  //caizhibang
	u_int16_t isr_rates[IEEE80211_RATE_MAXSIZE];
...
enum {
    ...
    IEEE80211_PARAM_TO_ENODE_MEDEBUG    = 265,   /*Add by zhanghu for converting multiply frame to umcast frame for every node 2012-12-24*/
    
    /*Start:Added by zhanghu for nrates and ntries*/
    IEEE80211_PARAM_N_RATES = 266,
    IEEE80211_PARAM_N_TRIES = 267,
    ...
    IEEE80211_PARAM_DEAUTH_SEND_INTERVAL = 268,
    IEEE80211_PARAM_QUEUE_INFO = 269,
    IEEE80211_PARAM_NODE_TRACE = 270,
    
	IEEE80211_PARAM_NODE_TABLE = 271,
};
/*
