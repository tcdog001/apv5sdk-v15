...
/* End:gengzongjie added end */
	...
	ATH_TXQ_STUCK_ENABLE =29,
	ATH_TXQ_STUCK_DEBUG = 30,
#endif
	/*zhaoyang modify end*/
...
/* Begin:gengzj added for rrm scan 2013-11-26*/
	ATH_IWLIST_SCAN_MODE = 49,
	ATH_IWLIST_SCAN_CHAN = 50,
	ATH_IWLIST_LISTEN_TIME_EACH_CHAN = 51,
/* End:gengzongjie added end */
...
ATH_SYSCTL_DECL(ath_sysctl_halparam, ctl, write, filp, buffer, lenp, ppos)
{
		...
		if(0 == ret)
		{
			switch ((long)ctl->extra2) {
				...
				/*zhaoyang modify for dusi check*/
#if ATH_HW_TXQ_STUCK_WAR
				case ATH_TXQ_STUCK_DEBUG:
					ath_txq_stuck_debug = val;
				break;
				case ATH_MAX_ABNORMITY_TIME:
					max_abnormity_time = val;
				break;
				case ATH_TXQ_STUCK_ENABLE:
					ath_txq_stuck_enable=val;
				break;
#endif
				/*zhaoyang modify end*/
				/*Begin:Added by duanmingzhe for 80211 cache*/
...
#if ATH_HW_TXQ_STUCK_WAR
			case ATH_TXQ_STUCK_DEBUG:
				val = ath_txq_stuck_debug;
				break;
			case ATH_MAX_ABNORMITY_TIME:
				val = max_abnormity_time;
				break;
			case ATH_TXQ_STUCK_ENABLE:
				val = ath_txq_stuck_enable;
				break;
#endif
			/*zhaoyang modify end*/
			/*Begin:Added by duanmingzhe for 80211 cache*/
...
/*End : add for 5G priority by caizhibang  2012-09-27> */		
...
#if ATH_HW_TXQ_STUCK_WAR
	{ .ctl_name         = CTL_AUTO,
      .procname         = "ath_txq_stuck_debug",
      .mode             = 0644,
      .proc_handler     = ath_sysctl_halparam,
   	  .extra2           = (void *)ATH_TXQ_STUCK_DEBUG,  
    },
	{ .ctl_name         = CTL_AUTO,
    ...
    { .ctl_name         = CTL_AUTO,
      .procname         = "ath_txq_stuck_enable",
      .mode             = 0644,
      .proc_handler     = ath_sysctl_halparam,
   	  .extra2           = (void *)ATH_TXQ_STUCK_ENABLE,  
    },
#endif
    /*zhaoyang add end*/
	/*Begin:Added by duanmingzhe for 80211 cache*/
