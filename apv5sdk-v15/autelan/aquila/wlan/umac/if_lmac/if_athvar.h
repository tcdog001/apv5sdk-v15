...
struct packet_power
{
    u_int8_t rssi_lower_limit;
    u_int8_t rssi_upper_limit;
    u_int16_t txpower;
};
/*ended by chenming*/
...
extern void 
ieee80211_scan_locate_nlsend(struct ieee80211_node *ni, wbuf_t wbuf, int subtype, struct ieee80211_rx_status *rs);
extern struct scan_locate iv_scan_notlocate;
