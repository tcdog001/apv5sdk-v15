                   ...
                   u_int hdrsize, u_int ciphdrsize, u_int mtu)
{
	...
	/*zhaoyang1 transplant from 717*/
	/*zhaoyang modify for frag count*/
	ni = ieee80211_find_node(&ic->ic_sta,wh->i_addr1);
	/*zhaoyang modify end*/
	/*zhaoyang1 transplant end*/
	...
	/*zhaoyang1 transplant from 717*/
		...
		if(ni != NULL)
		{
			IEEE80211_NODE_STAT(ni, tx_frag);
		}
		/*zhaoyang modify end*/
	} while (remainder != 0);
	/*zhaoyang modify for frag count*/
	...
	ieee80211_free_node(ni); //AUTELAN-Added:Added by duanmingzhe for cannot create interface when set fragment 300 and association a sta then destroy interface
	/*zhaoyang modify end*/
	/*zhaoyang1 transplant end*/
                 ...
                 int hdrlen)
{
	...
	if(more_frag)
	{
		IEEE80211_NODE_STAT(ni, rx_frag);
	}
	/*zhaoyang modify end*/
	/*zhaoyang1 transplant end*/
