    ...
    u_int8_t * pPDADCValues, u_int16_t numXpdGains)
{
    ...
    u_int8_t   minPwrT4[AR5416_EEPDEF_NUM_PD_GAINS] = {0}; //AUTELAN-Added:Modified by duanmingzhe for fixed bug from coverity check
    u_int8_t   maxPwrT4[AR5416_EEPDEF_NUM_PD_GAINS] = {0}; //AUTELAN-Added:Modified by duanmingzhe for fixed bug from coverity check
    int16_t   vpdStep;
    int16_t   tmpVal;
