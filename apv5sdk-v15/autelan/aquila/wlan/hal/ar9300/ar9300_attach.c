...
static const struct ath_hal_private ar9300hal = {
    {
        ...
        ar9300CalcTxRetryCount,              /* ah_calcTxRetryCount */
		/*zhaoyang modify end*/
	...
	ar9300ForceVCS,
        ...
        ar9300SetCcaThreshold,              /* ah_setCcaThreshold */
        ar9300GetCcaThreshold,              /* ah_getCcaThreshold */
        ar9300GetCtlChanNF,                 /* ah_arGetCtlNF */
        ar9300GetExtChanNF,                 /* ah_arGetExtNF */
        /*lijiyong add end*/

        /*lijiyong add begin for debug noise immunity level*/
        ar9300AniSetOdfmNoiseImmunityLevel, /* ah_setOfdmNoiseImmunityLevel */
        ar9300AniSetCckNoiseImmunityLevel,  /* ah_setCckNoiseImmunityLevel */
        /*lijiyong add end*/
