...
/*lijiyong modify begin for debug cca*/
#if 0
...
extern int16_t ar9300GetCtlChanNF(struct ath_hal *ah);
extern int16_t ar9300GetExtChanNF(struct ath_hal *ah);
/*lijiyong modify end*/
...
extern void ar9300AniSetOdfmNoiseImmunityLevel(struct ath_hal *ah, u_int8_t immunityLevel);
extern void ar9300AniSetCckNoiseImmunityLevel(struct ath_hal *ah, u_int8_t immunityLevel);
/*lijiyong add end*/
/*End: Transplant from v5 cmcc, wangjia.*/
