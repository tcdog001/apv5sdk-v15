#ifndef CAT_SERVICE_H
#define CAT_SERVICE_H
/**
...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 QUALCOMM Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/cat/main/latest/api/card_application_toolkit_v02.h#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
 *THIS IS AN AUTO GENERATED FILE. DO NOT ALTER IN ANY WAY 
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/* This file was generated with Tool version 4.1
   It was generated on: Wed Nov  9 2011
...
#define CAT_V02_IDL_MINOR_VERS 0x09
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define CAT_V02_IDL_TOOL_VERS 0x04
/** Maximum Defined Message ID */
#define CAT_V02_MAX_MESSAGE_ID 0x002B;
/** 
    @} 
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Decode Event Reporting Request */
...
typedef struct {
  ...
  /**<   Proactive command event report registration error bitmask \n
       ...
       - Bit 24 -- Activate \n
       - Bit 25 -- Setup Event -- HCI connectivity \n
       Each bit set indicates that the proactive command was registered before
       and caused the error; all unused bits are reserved for future use and
...
typedef struct {
  ...
  /**<   Display text proactive command encoded as in [S1, Section 6.6.1] */
...
typedef struct {
  ...
  /**<   Get Inkey proactive command encoded as in [S1, Section 6.6.2] */
...
typedef struct {
  ...
  /**<   Get Input proactive command encoded as in [S1, Section 6.6.3] */
...
typedef struct {
  ...
  /**<   Setup Menu proactive command encoded as in [S1, Section 6.6.7] */
...
typedef struct {
  ...
  /**<   Select Item proactive command encoded as in [S1, Section 6.6.8] */
...
typedef struct {
  ...
  /**<   Alpha identifier as in [S1, Section 8.2] */
...
typedef struct {
  ...
  /**<   As indicated in [S1, Section 8.6] (command qualifier for refresh) */
...
typedef struct {
  ...
  /**<   Icon qualifier \n
       ...
       - 0x01 -- Icon is not self-explanatory; it displays along with text
   */
...
typedef struct {
  ...
  /**<   Tone to be played \n
       ...
       - 0x03 -- Congestion \n
       - 0x04 -- Radio path ACK \n
       - 0x05 -- Radio path not available call drop \n
       - 0x06 -- Error tone \n
       ...
       - 0x0C -- Ringing tone selected by the user \n
...
typedef struct {
  ...
  /**<   Display icon only \n
       - 0x00 -- Do not display the icon \n
       - 0x01 -- Display only the icon
   */
...
typedef struct {
  ...
  /**<   Indicates if packing is required \n
...
typedef struct {
  ...
  /**<   Address -- Decoded BCD string in ASCII format, maximum
       length of the address is 200 bytes [S2, Section 8.1].
   */
...
typedef struct {
  ...
  /**<   Indicates if redial is necessary \n
  ...
  /**<   Time interval -- This value must be greater than zero if
       redial_necessary is set to 0x01 [S2, Section 8.8].
   */
...
typedef struct {
  ...
  /**<   Subaddress -- in BCD format (two digits encoded in one byte).
       Maximum size of the subaddress is 20 bytes.[S2, Section 8.3].
   */
...
typedef struct {
  ...
  /**<   Capability configuration data [S2, Section 8.4] */
...
typedef struct {
  ...
  /**<   DTMF data -- in BCD format (two digits encoded in one byte) [S2, Section 8.44]. */
...
typedef struct {
  ...
  /**<   Language value -- Each language code is a pair of alphanumeric
       characters, defined in [S3]; each alphanumeric character is coded on
       one byte using the SMS default 7-bit coded alphabet, as defined in
       [S2, Section 8.45], with bit 8 set to 0
   */
...
typedef struct {
  ...
  /**<   Path to the provisioning file [S2, Section 8.50] */
...
typedef struct {
  ...
  /**<   Text of USSD string [S4, Section 8.17]
   */
...
typedef struct {
  ...
  /**<   Indicates if an immediate response is required \n
       - 0x00 -- No \n
       - 0x01 -- Yes
   */
...
typedef struct {
  ...
  /**<   Indicates if the notification for a setup event list is required \n
...
typedef struct {
  ...
  /**<   Play tone proactive command encoded as in [S1, Section 6.6.5] */
...
typedef struct {
  ...
  /**<   Setup call proactive command encoded as in [S1, Section 6.6.12] */
...
typedef struct {
  ...
  /**<   Send DTMF proactive command encoded as in [S1, Section 6.6.24] */
...
typedef struct {
  ...
  /**<   Launch browser proactive command encoded as in [S1, Section 6.6.26] */
...
typedef struct {
  ...
  /**<   Send SMS proactive command encoded as in [S1, Section 6.6.9] */
...
typedef struct {
  ...
  /**<   Send SS proactive command encoded as in [S1, Section 6.6.10] */
...
typedef struct {
  ...
  /**<   Send USSD proactive command encoded as in [S4, Section 6.6.11] */
...
typedef struct {
  ...
  /**<   Provide local information proactive command encoded as in [S1, Section 6.6.15] */
...
typedef struct {
  ...
  /**<   Setup event list proactive command encoded as in [S1, Section 6.6.16] */
...
typedef struct {
  ...
  /**<   Open channel proactive command encoded as in [S1, Section 6.6.27] */
...
typedef struct {
  ...
  /**<   Close channel proactive command encoded as in [S1, Section 6.6.28] */
...
typedef struct {
  ...
  /**<   Send data proactive command encoded as in [S1, Section 6.6.30] */
...
typedef struct {
  ...
  /**<   Receive data proactive command encoded as in [S1, Section 6.6.29] */
...
typedef struct {
  ...
  /**<   Indicates if the link is required \n
...
typedef struct {
  ...
  uint8_t speed;
  /**<   Data rate: same as the speed subparameter defined in [S5, Section 6.7] */
...
typedef struct {
  ...
  /**<   Precedence class: same as the precedence subparameter, defined in [S4, Section 8.52.2] */

  uint8_t delay_cls;
  /**<   Delay class: same as the delay subparameter, defined in [S4, Section 8.52.2] */

  uint8_t reliability_cls;
  /**<   Reliability class: same as the reliability subparameter, defined in [S4, Section 8.52.2] */

  uint8_t peak_throughput;
  /**<   Peak throughput class: same as the peak subparameter, defined in [S4, Section 8.52.2] */

  uint8_t mean_throughput;
  /**<   Mean throughput class: same as the mean subparameter, defined in [S4, Section 8.52.2] */
...
typedef struct {
  ...
  /**<   Residual bit error ratio -- Same as the residual bit error ratio
       subparameter, defined in [S4, Section 8.52.3]
   */
...
typedef struct {
  ...
  uint8_t qci;
  /**<   QCI [S4, Section 8.52.5] */

  uint8_t max_bitrate_ul;
  /**<   Maximum bitrate UL [S4, Section 8.52.5] */

  uint8_t max_bitrate_dl;
  /**<   Maximum bitrate DL [S4, Section 8.52.5] */

  uint8_t guaranteed_bitrate_ul;
  /**<   Guaranteed bitrate UL [S4, Section 8.52.5] */

  uint8_t guaranteed_bitrate_dl;
  /**<   Guaranteed bitrate DL [S4, Section 8.52.5] */

  uint8_t max_bitrate_ul_ext;
  /**<   Maximum bitrate UL Ext [S4, Section 8.52.5] */

  uint8_t max_bitrate_dl_ext;
  /**<   Maximum bitrate DL Ext [S4, Section 8.52.5] */

  uint8_t guaranteed_bitrate_ul_ext;
  /**<   Guaranteed bitrate UL Ext [S4, Section 8.52.5] */

  uint8_t guaranteed_bitrate_dl_ext;
  /**<   Guaranteed bitrate DL Ext [S4, Section 8.52.5] */
...
typedef struct {
  ...
  /**<   Network access name [S2, Section 8.70] */
...
typedef struct {
  ...
  /**<   Number of bytes that are available in the channel buffer, or the number
       of bytes that are requested in a Received Data command [S2, Section 8.54].
   */
...
typedef struct {
  ...
  /**<   Activate proactive command encoded as in [S1, Section 6.6.40] */
...
typedef struct {
  ...
  /**<   Activate descriptor target [S2, Section 8.89]\n
       - 0x01 -- UICC-CLF interface according to TS 102 613 \n
...
typedef struct {
  ...
  /* Optional */
  /*  Alpha Identifier Available (used only when QMI_CAT is configured in Gobi@latexonly\texttrademark~@endlatexonly mode) */
...
typedef struct {
  ...
  /**<   Bitmask of events registered by all control points \n
       ...
       - Bit 24 -- Activate \n
       - Bit 25 -- Setup Event -- HCI connectivity \n
       All unused bits are reserved for future use and are ignored
   */
...
/** @addtogroup cat_qmi_messages
    @{
  */
/** Response Message; Queries QMI_CAT service state. */
typedef struct {
...
typedef struct {
  ...
  uint32_t uim_ref_id;
  /**<   Proactive command reference ID; the same reference ID as indicated in the
       event report indication for the relevant proactive command
   */
...
typedef struct {
  ...
  /**<   Encoded envelope response as defined in [S1, Section 7] */
...
typedef struct {
  ...
  uint8_t sw1;
  /**<   Value of SW1 of the response as defined in [S8] for ICC
       and [S9] for UICC.
   */

  uint8_t sw2;
  /**<   Value of SW2 of the response as defined in [S8] for ICC
       and [S9] for UICC.
   */
...
typedef struct {
  ...
  /**<   Result of the proactive command as defined in [S1, Section 8.12] */
  ...
  /**<   Additional information is only required for some commands; [S1,
...
typedef struct {
  ...
  /**<   Text of get inkey. In case of Yes/No input required from the user, the
       DCS value is ignored and the string should contain only 1 byte: 0x00
       for No, 0x01 for Yes.
   */
...
typedef struct {
  ...
  /**<   Yes / No input for get inkey. \n
      - 0x00  -- No \n
      - 0x01  -- Yes \n
       In case of Text input required from the user, get_inkey_extra_info TLV
       should be used.
   */
...
typedef struct {
  ...
  /**<   Decoded envelope command type; see Appendix D for information on mandatory
       and optional TLVs for each envelope command \n
       - 0x01 - Menu Selection \n
...
typedef struct {
  ...
  uint8_t identifier;
  /**<   Identifier of the item chosen; valid values are \n
       0x00 to 0xFF
   */
...
typedef struct {
  ...
  /**<   PDP context activation data; coded as the Activate PDP Context
       Request message, specified in TS 24.008
   */
...
typedef struct {
  ...
  /**<   EPS PDN connect activation data; coded as the PDN Connectivity
       Request message, specified in [S7].
   */
