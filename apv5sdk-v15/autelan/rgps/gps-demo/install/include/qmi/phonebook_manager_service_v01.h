...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 QUALCOMM Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/pbm/main/latest/api/phonebook_manager_service_v01.h#8 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 5.2 
   It was generated on: Mon May  7 2012
...
#define PBM_V01_IDL_MINOR_VERS 0x0A
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define PBM_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define PBM_V01_MAX_MESSAGE_ID 0x001C;
/** 
    @} 
  */
...
typedef struct {
  ...
  /**<   Bitmask of the events to be registered: \n
       - 0x01 -- PBM_REG_RECORD_UPDATE_EVENTS --
                 Record Update events \n
       - 0x02 -- PBM_REG_PHONEBOOK_READY_EVENTS --
                 Phonebook Ready events \n
       - 0x04 -- PBM_REG_EMERGENCY_NUMBER_LIST_EVENTS -- 
                 Emergency Number List events \n
       - 0x08 -- PBM_REG_HIDDEN_RECORD_STATUS_EVENTS --
                 Hidden Record Status events \n
       - 0x10 -- PBM_REG_AAS_UPDATE_EVENTS --
                 Additional number Alpha String Update events \n
       - 0x20 -- PBM_REG_GAS_UPDATE_EVENTS --
...
typedef struct {
  ...
  pbm_reg_mask_type_v01 reg_mask;
  /**<   Bitmask of the registered events: \n
       - 0x01 -- PBM_REG_RECORD_UPDATE_EVENTS --
                 Record Update events \n
       - 0x02 -- PBM_REG_PHONEBOOK_READY_EVENTS --
                 Phonebook Ready events \n
...
typedef struct {
  ...
  /**<   Session types are provided in Table @latexonly\ref{tbl:SessTypes}@endlatexonly.  */

  uint16_t pb_type;
  /**<   Phonebook types are provided in Table @latexonly\ref{tbl:suppPB}@endlatexonly.  */
...
typedef struct {
  ...
  pbm_session_type_enum_v01 session_type;
  /**<   Session types are provided in @latexonly\ref{tbl:SessTypes}@endlatexonly.  */
...
/** Request Message; Initiates the ADN Phonebook Set capabilities read operation by 
             specifying the range of the Phonebook Set's to be read. */
typedef struct {
...
typedef struct {
  ...
  /**<   Type of number, as per @latexonly\hyperref[S1]{[S1]}@endlatexonly: \n
...
typedef struct {
  ...
  uint16_t pb_type;
  /**<   Phonebook types provided in Table @latexonly\ref{tbl:suppPB}@endlatexonly.  */

  pbm_operation_enum_v01 operation;
  /**<   Action performed on the record: \n
       - 0x01 -- PBM_OPERATION_ADD -- Add \n
       - 0x02 -- PBM_OPERATION_MODIFY -- Modify \n
       - 0x03 -- PBM_OPERATION_DELETE -- Delete
   */
...
typedef struct {
  ...
  /**<   Bitmask of Emergency number categories, which are provided in
       Table @latexonly\ref{tbl:EmgcyCat}@endlatexonly.  */
...
typedef struct {
  ...
  /**<   Bitmask of phonebook types, which are provided in
       Table @latexonly\ref{tbl:suppPB}@endlatexonly.  */
...
typedef struct {
 ...
 Mappin type. Values: \n  
       - 0x00 -- PBM_MAPPING_TYPE_1 --
                 linear mapping between ADN & USIM fields. \n
       - 0x01 -- PBM_MAPPING_TYPE_2 --
                 non linear mapping between ADN & USIM fields. 
      */
  ...
  /**<   length of resord that can be used by clients to fill the field   */
...
typedef struct {
  ...
  /**<   Operation performed on a Group name: \n 
       - 0x00 -- PBM_GROUP_OPERATION_ADD -- Add \n
       - 0x01 -- PBM_GROUP_OPERATION_MODIFY -- Modify \n
       - 0x02 -- PBM_GROUP_OPERATION_DELETE -- Delete
   */
...
typedef struct {
  ...
  /**<   State of the phonebook: \n
       - 0x00 -- PBM_PB_STATE_READY -- Ready \n
       - 0x01 -- PBM_PB_STATE_NOT_READY -- Not ready \n
       - 0x02 -- PBM_PB_STATE_NOT_AVAILABLE -- Not available \n
       - 0x03 -- PBM_PB_STATE_PIN_RESTRICTION -- PIN restriction \n
       - 0x04 -- PB_STATE_PUK_RESTRICTION -- PUK restriction \n
       - 0x05 -- PB_STATE_INVALIDATED -- Invalidated \n
       - 0x06 -- PB_STATE_SYNC -- In synchronization
   */
...
typedef struct {
  ...
  /**<   Current status of hidden records: \n
       - 0x01 -- PBM_HIDDEN_STATUS_VALID -- 
                 Hidden records are valid and accessible \n
       - 0x02 -- PBM_HIDDEN_STATUS_NOT_VALID -- 
...
typedef struct {
  ...
  /**<   Operation performed on the AAS: \n 
       - 0x00 -- PBM_AAS_OPERATION_ADD -- Add \n
       - 0x01 -- PBM_AAS_OPERATION_MODIFY -- Modify \n
       - 0x02 -- PBM_AAS_OPERATION_DELETE -- Delete
   */
...
typedef struct {
  ...
  /**<   Subscription type: \n
       - 0x00 -- PBM_SUBS_TYPE_PRIMARY -- Primary subscription \n
       - 0x01 -- PBM_SUBS_TYPE_SECONDARY -- Secondary subscription
   */
