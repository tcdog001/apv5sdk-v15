...
/* This file was generated with Tool version 5.2 
   It was generated on: Tue May 15 2012
...
#define NAS_V01_IDL_MINOR_VERS 0x1E
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x006C;
/** 
    @} 
  */
...
typedef struct {
 ...
 Standard response type. Contains the following data members:
  ...
  /**<   Indicates the success status of the network scan
       - 0x00 -- NAS_SCAN_SUCCESS - Network scan was successful
       - 0x01 -- NAS_SCAN_AS_ABORT - Network scan was aborted
       - 0x02 -- NAS_SCAN_REJ_IN_RLF - Network scan did not complete due to radio link failure recovery in progress
   */
...
typedef struct {
  ...
  /**<   This field is used to interpret the length of the corresponding
       MNC reported in the PLMN TLV (0x01). Values: \n
        ...
        - TRUE  -- The MNC is a 3 digit value. For example, a reported value
                   of 90 corresponds to an MNC value of 090

        - FALSE -- The MNC is a 2 digit value. For example, a reported value
                   of 90 corresponds to an MNC value of 90.

       If this TLV is not present, MNC smaller than 100 are assumed to be a 2 digit value, 
       and MNC greater or equal to 100 are assumed to be a 3 digit value.
     */
  ...
  /**<   This field is used to indicate client would like to receive PLMN name, regardless
       of EF display condition. Values: \n
       - FALSE -- EF SPN PLMN display condition will be looked at before attempting to 
                  retrieve name. \n
       - TRUE  -- PLMN name will be returned regardless of EF SPN PLMN display condition.
   */
  ...
  /**<   This field indicates client would like to receive network name only from Static Table.
       Values: \n
       - FALSE -- Normal procedure will be followed when determining network name (Default Value) \n
       - TRUE  -- SIM inititalization state and EF SPN PLMN display condition will be ignored. Network
                  name will be read directly from Static Table.
   */
...
typedef struct {
  ...
  /**<  
    ...
    For CDMA, MCC wildcard value is returned as {'3', 0xFF, 0xFF}.
   */
  ...
  /**<  
     ...
     For CDMA, MNC wildcard value is returned as {'7', 0xFF, 0xFF}. 
   */
...
typedef enum {
 ...
 Voice is supported over 3GPP network  */
  NAS_LTE_VOICE_STATUS_3GPP_V01 = 3, 
...
typedef struct {
  ...
  /**<  
      RSSI in 1 dBm. A value of -125 dBm or lower is
      used to indicate No Signal. 
      ...
      Maximum number of threshold values is 16, each a signed byte value.
      ...
      The range is based on latest releases, and may change over time.
  */
  ...
  */
  ...
  /**<  
      RSCP in 1 dBm. RSCP values have the following range: \n
      - TDSCDMA       is -120 to -57 (in dBm)
       The threshold values specified here are used for all RATs.
    */
...
typedef struct {
  ...
  /**<  
      Array of RSSI thresholds (in units of .1dBm), maximum of 32 values
      RSSI values have range of -105 to -21 (in dBm).
      For example, to set thresholds at -20 dBm and -15 dBm, threshold list values would be {-200, -150}
      The range is based on latest releases, and may change over time.
  */
  ...
  /**<  
      ...
      Value of 0 will be rejected with QMI_ERR_INVALID_ARG.
      For example, to set delta of 10 dBm, delta value should be set to 100
  */
  ...
  /**<  
      Array of ECIO thresholds (in units of .1dB), maximum of 32 values
      ECIO values have range of -31.5 to 0 (in dB).
      For example, to set thresholds at -20 dB and -15.5 dB, threshold list values would be {-400, -310}
      The range is based on latest releases, and may change over time.
  */
  ...
  /**<  
      ...
      Value of 0 will be rejected with QMI_ERR_INVALID_ARG.
      For example, to set delta of 10 dB, delta value should be set to 100
  */
  ...
  /**<  
      Array of RSSI thresholds (in units of .1dBm), maximum of 32 values
      RSSI values have range of -118 to -13 (in dBm).
      For example, to set thresholds at -20 dBm and -15 dBm, threshold list values would be {-200, -150}
      The range is based on latest releases, and may change over time.
  */
  ...
  */
  ...
  /**<  
      ...
      Value of 0 will be rejected with QMI_ERR_INVALID_ARG.
      For example, to set delta of 1 SINR level, delta value should be set to 1
  */
  ...
  /**<  
      Array of IO thresholds (in units of .1dBm), maximum of 32 values
      IO values have range of -128 to -13 (in dBm).
      For example, to set thresholds at -111 dBm and -73 dBm, threshold list values would be {-1110, -730}
      The range is based on latest releases, and may change over time.
  */
  ...
  */
  ...
  /**<  
      Array of RSSI thresholds (in units of .1dBm), maximum of 32 values
      RSSI values have range of -111 to -48 (in dBm).
      For example, to set thresholds at -20 dBm and -15 dBm, threshold list values would be {-200, -150}
      The range is based on latest releases, and may change over time.
  */
  ...
  */
  ...
  /**<  
      Array of RSSI thresholds (in units of .1dBm), maximum of 32 values
      RSSI values have range of -121 to 0 (in dBm).
      For example, to set thresholds at -20 dBm and -15 dBm, threshold list values would be {-200, -150}
      The range is based on latest releases, and may change over time.
  */
  ...
  */
  ...
  /**<  
      Array of RSSI thresholds (in units of .1dBm), maximum of 32 values
      RSSI values have range of -120 to 0 (in dBm).
      For example, to set thresholds at -20 dBm and -15 dBm, threshold list values would be {-200, -150}
      The range is based on latest releases, and may change over time.
  */
  ...
  */
  ...
  /**<  
      Array of SNR thresholds (in units of .1dB), maximum of 32 values
      SNR values have range of -20 to 30 (in dB).
      For example, to set thresholds at -19.8 dB and 23 dB, threshold list values would be {-198, 230}
      The range is based on latest releases, and may change over time.
  */
  ...
  */
  ...
  /**<  
      Array of RSRQ thresholds (in units of .1dBm), maximum of 32 values
      RSRQ values have range of -20 to -3 (in dBm).
      For example, to set thresholds at -11 dBm and -6 dBm, threshold list values would be {-110, -60}
      The range is based on latest releases, and may change over time.
  */
  ...
  */
  ...
  /**<  
      Array of RSRP thresholds (in units of .1dBm), maximum of 32 values
      RSRP values have range of -140 to -44 (in dBm).
      For example, to set thresholds at -125 dBm and -64 dBm, threshold list values would be {-1250, -640}
      The range is based on latest releases, and may change over time.
  */
  ...
  */
  ...
  nas_lte_sig_rpt_config_type_v01 lte_sig_rpt_config;
  /**<  
      Sets signal reporting rate and averaging period information for LTE
  */
  ...
  /**<  
      Array of RSCP thresholds (in units of .1dBm), maximum of 32 values
      RSCP values have range of -120 to -57 (in dBm).
      For example, to set thresholds at -20 dBm and -15 dBm, threshold list values would be {-200, -150}
      The range is based on latest releases, and may change over time.
  */
