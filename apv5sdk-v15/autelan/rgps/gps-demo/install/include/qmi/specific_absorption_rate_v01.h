...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
                        ...
                        S P E C I F I C _ A B S O R P T I O N _ R A T E _ V 0 1  . H

GENERAL DESCRIPTION
  This is the public header file which defines the sar service Data structures.
...
/* This file was generated with Tool version 02.04 
   It was generated on: Thu Apr  7 2011
...
#define SAR_V01_IDL_MAJOR_VERS 01
#define SAR_V01_IDL_MINOR_VERS 00
#define SAR_V01_IDL_TOOL_VERS 02

typedef enum {
  QMI_SAR_RF_STATE_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /*To force a 32 bit signed enum.  Do not change or use*/
  QMI_SAR_RF_STATE_DEFAULT_V01 = 0,
  QMI_SAR_RF_STATE_1_V01 = 1,
  QMI_SAR_RF_STATE_2_V01 = 2,
  QMI_SAR_RF_STATE_3_V01 = 3,
  QMI_SAR_RF_STATE_4_V01 = 4,
  QMI_SAR_RF_STATE_5_V01 = 5,
  QMI_SAR_RF_STATE_6_V01 = 6,
  QMI_SAR_RF_STATE_7_V01 = 7,
  QMI_SAR_RF_STATE_8_V01 = 8,
