...
/* This file was generated with Tool version 4.1
   It was generated on: Fri Nov  4 2011
...
#define WMS_V01_IDL_MINOR_VERS 0x05
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define WMS_V01_IDL_TOOL_VERS 0x04
/** Maximum Defined Message ID */
#define WMS_V01_MAX_MESSAGE_ID 0x005D;
/** 
    @} 
  */
...
typedef struct {
  ...
  /**<   Parameter to indicate if ACK needs to be
         ...
         - 0x00 -- ACK_INDICATOR_SEND_ACK -- Send ACK \n
  ...
  /**<   Message format. Values: \n
         ...
         - 0x07 -- MESSAGE_FORMAT_GW_BC -- GW_BC 
     */
...
typedef struct {
  ...
  /**<   Indicates whether the message is received from IMS. Values: \n
         ...
         Note: In multiple modem solutions, this TLV may be used to help
         the client determine with which modem to communicate. This TLV
...
typedef struct {
  ...
  /**<   Indicates whether the message is to be sent on IMS. Values: \n
         ...
         - 0x02 to 0xFF -- Reserved \n
         Note: In multiple modem solutions, this TLV may be used to help
         the client determine with which modem to communicate.
     */
  ...
  /**<   Indicates this message is a retry. Values: \n
         - 0x01 -- WMS_MESSAGE_IS_A_RETRY -- Message is a retry message

         Any value other than 0x01 in this field will
         be treated as absence of this TLV
     */
...
typedef enum {
  ...
  WMS_TP_CAUSE_TELE_INTERWORKING_NOT_SUPPORTED_V01 = 0x80, 
  WMS_TP_CAUSE_SHORT_MESSAGE_TYPE_0_NOT_SUPPORTED_V01 = 0x81, 
  WMS_TP_CAUSE_SHORT_MESSAGE_CANNOT_BE_REPLACED_V01 = 0x82, 
  WMS_TP_CAUSE_UNSPECIFIED_PID_ERROR_V01 = 0x8F, 
  WMS_TP_CAUSE_DCS_NOT_SUPPORTED_V01 = 0x90, 
  WMS_TP_CAUSE_MESSAGE_CLASS_NOT_SUPPORTED_V01 = 0x91, 
  WMS_TP_CAUSE_UNSPECIFIED_DCS_ERROR_V01 = 0x9F, 
  WMS_TP_CAUSE_COMMAND_CANNOT_BE_ACTIONED_V01 = 0xA0, 
  WMS_TP_CAUSE_COMMAND_UNSUPPORTED_V01 = 0xA1, 
  WMS_TP_CAUSE_UNSPECIFIED_COMMAND_ERROR_V01 = 0xAF, 
  WMS_TP_CAUSE_TPDU_NOT_SUPPORTED_V01 = 0xB0, 
  WMS_TP_CAUSE_SC_BUSY_V01 = 0xC0, 
  WMS_TP_CAUSE_NO_SC_SUBSCRIPTION_V01 = 0xC1, 
  WMS_TP_CAUSE_SC_SYS_FAILURE_V01 = 0xC2, 
  WMS_TP_CAUSE_INVALID_SME_ADDRESS_V01 = 0xC3, 
  WMS_TP_CAUSE_DESTINATION_SME_BARRED_V01 = 0xC4, 
  WMS_TP_CAUSE_SM_REJECTED_OR_DUPLICATE_V01 = 0xC5, 
  WMS_TP_CAUSE_TP_VPF_NOT_SUPPORTED_V01 = 0xC6, 
  WMS_TP_CAUSE_TP_VP_NOT_SUPPORTED_V01 = 0xC7, 
  WMS_TP_CAUSE_SIM_SMS_STORAGE_FULL_V01 = 0xD0, 
  WMS_TP_CAUSE_NO_SMS_STORAGE_CAP_IN_SIM_V01 = 0xD1, 
  WMS_TP_CAUSE_MS_ERROR_V01 = 0xD2, 
  WMS_TP_CAUSE_MEMORY_CAP_EXCEEDED_V01 = 0xD3, 
  WMS_TP_CAUSE_SIM_APP_TOOLKIT_BUSY_V01 = 0xD4, 
  WMS_TP_CAUSE_SIM_DATA_DOWNLOAD_ERROR_V01 = 0xD5, 
  WMS_TP_CAUSE_UNSPECIFIED_ERROR_V01 = 0xFF, 
...
typedef struct {
  ...
  /**<   GW RP cause per [S5, Section 8.2.5.4]; see Table
          @latexonly \ref{tbl:GWRPCauseCodes} @endlatexonly for more 
          information
     */

  wms_tp_cause_enum_v01 tp_cause;
  /**<   GW TP cause per [S2, Section 9.2.3.22]; see Table 
...
typedef struct {
  ...
  /**<   WMS cause code per [S4, Section 6.5.2.125]; see Table 
  ...
  /**<   Message Delivery Failure Type. Values: \n
       - 0x00 -- WMS_MESSAGE_DELIVERY_ FAILURE_TEMPORARY \n
       - 0x01 -- WMS_MESSAGE_DELIVERY_ FAILURE_PERMANENT
   */
...
typedef struct {
  ...
  /**<   Message class. Values: \n 
       - 0x00 -- MESSAGE_CLASS_0    -- Class 0 \n 
       - 0x01 -- MESSAGE_CLASS_1    -- Class 1 \n 
       - 0x02 -- MESSAGE_CLASS_2    -- Class 2 \n 
       - 0x03 -- MESSAGE_CLASS_3    -- Class 3 \n 
...
typedef struct {
  ...
  /**<   Route value. Values: \n 
       ...
       - 0x03 -- TRANSFER_AND_ACK -- Incoming messages for this route are
                                     transferred to the client, and ACK is
                                     sent to the network \n 
       - 0xFF -- UNKNOWN          -- Incoming messages for this route are
...
typedef struct {
  ...
  uint8_t success;
  /**<   MT message processed successfully. Values: \n 
       - 0x00 -- Failure \n 
       - 0x01 -- Success
   */
...
typedef struct {
  ...
  /**<   WMS transport layer status conveying the CDMA
       cause code per [S1, Section 3.4.3.6]; see Table
       @latexonly \ref{tbl:WMSCauseCodes} @endlatexonly for more 
       information
   */
...
typedef struct {
  ...
  /**<   Relay layer protocol cause (RP-Cause) per [S5, Section 8.2.5.4]; see 
       Table @latexonly \ref{tbl:GWRPCauseCodes} @endlatexonly for more 
       information
   */
...
typedef struct {
  ...
  /**<   ACK Failure Cause. Values: \n 
     - 0x00 -- ACK_FAILURE_NO_NETWORK_ RESPONSE \n 
     - 0x01 -- ACK_FAILURE_NETWORK_ RELEASED_LINK \n 
     - 0x02 -- ACK_FAILURE_ACK_NOT_SENT */
...
typedef struct {
  ...
  /**<   Retry period in seconds up to which the WMS retries
       ...
       retry_period is 0 seconds, retry is not attempted
   */
...
typedef struct {
  ...
  /**<   Starting point of the range of CBM message identifiers; message IDs are
       defined in [S6, Section 9.4.1.2.2] for GSM and [S6, Section 9.4.4.2.2]
       for UMTS
   */
...
typedef struct {
  ...
  /**<   Service category assignments, as defined in [S7, Section 9.3]; see Table 
       @latexonly \ref{tbl:ServiceCategories} @endlatexonly for more information
   */

  wms_language_enum_v01 language;
  /**<   Language indicator value assignments, as defined in [S7, Section 9.2]. 
       Values: \n 
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Allows the client to set or unset itself as the primary client of QMI_WMS. */
typedef struct {
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Response Message; Allows the client to set or unset itself as the primary client of QMI_WMS. */
typedef struct {
...
typedef struct {
  ...
  /**<   Destination address as defined in [S2, Section 9.2.3.8]
   */
  ...
  /**<   Protocol Identifier Data (PID) per [S2, Section 9.2.3.9]; see Table 
  ...
  uint8_t dcs;
  /**<   SMS Data Coding Scheme as defined in [S8, Section 4]
   */
  ...
  uint8_t validity;
  /**<   Relative Validity Period as defined in [S2, Section 9.2.3.12.1]
   */
...
typedef struct {
  ...
  /**<   LTE domain preference
       - 0x00 - WMS_LTE_DOMAIN_PREF_NONE
       - 0x01 - WMS_LTE_DOMAIN_PREF_IMS
   */
