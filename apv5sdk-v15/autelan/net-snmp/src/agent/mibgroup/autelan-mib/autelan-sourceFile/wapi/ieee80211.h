...
* All rights reserved.
*
* filename: ieee80211.h
* description:  implementation for wireless protocol definitions.
* 
*
* 
************************************************************************************/
...
/*ljy--add begin to match our driver ioctl*/
#ifndef __packed
...
/*
 * WAPI  load balancing information element.
 */
struct ieee80211_ie_wlb {
	u_int8_t	wlb_id;			/* IEEE80211_ELEMID_VENDOR */
	u_int8_t	wlb_len;			/* length in bytes */
	u_int8_t	wlb_oui[3];		/* 0x00, 0x14, 0x72 */
	u_int8_t	wlb_oui_type;		/* OUI type */
	u_int8_t	wlb_max_stas;	/*  */
	u_int8_t	wlb_asso_sta;		/* Capability info */
} __packed;

/*
 * WAPI  vap with cert downloading  information element.
 */
struct ieee80211_ie_dl_cert {
	u_int8_t	dl_cert_id;			/* IEEE80211_ELEMID_VENDOR */
	u_int8_t	dl_cert_len;			/* length in bytes */
	u_int8_t	dl_cert_oui[3];		/* 0x00, 0x14, 0x72 */
	u_int8_t	dl_cert_oui_type;		/* OUI type */
	u_int8_t	auth;
	u_int8_t  pad;
} __packed;
struct ieee80211_ie_add_host {
	u_int8_t	host_ie_id;			/* IEEE80211_ELEMID_VENDOR */
	u_int8_t	host_ie_len;			/* length in bytes */
	u_int8_t	host_ie_oui[3];		/* 0x00, 0x14, 0x72 */
	u_int8_t	host_ie_oui_type;		/* OUI type */
	u_int8_t	host_name_len;
...
/*ljy--add begin for spoofing attack*/
...
/*ljy--add begin for wapi*/
#define	WLB_OUI			0x721400		/* WAPI OUI */
#define	WLB_OUI_TYPE		0xf0
#define	DL_CERT_OUI_TYPE		0xf1
#define	HOST_NAME_OUI_TYPE		0xf2
/*ljy--add end*/
...
enum {
	...
	/*ljy--add begin for wapi*/
	IEEE80211_REASON_IV_FAILURE		= 15,
	IEEE80211_REASON_DDOS			= 16,
	/*ljy--add end*/
