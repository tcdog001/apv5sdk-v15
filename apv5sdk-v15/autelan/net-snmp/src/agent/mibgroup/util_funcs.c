                    ...
                    WriteMethod ** write_method, int max)
{
    ...
    if (rtest > 0 ||
        ...
        if (var_len)
            *var_len = 0;
		/*ljy--test start*/
		printf("%s: test 1. rtest %d, exact %d, *length %d, vp->namelen %d.\n", __func__, rtest, exact, *length, vp->namelen);
		/*ljy--test end*/
        return MATCH_FAILED;
    }
	...
	/*ljy--test start*/
	printf("%s: test 3. rtest %d, exact %d, *length %d, vp->namelen %d.\n", __func__, rtest, exact, *length, vp->namelen);
	/*ljy--test end*/
    ...
    if ((max >= 0 && ((int)newname[*length - 1] > max)) ||
        ...
        if (var_len)
            *var_len = 0;
		/*ljy--test start*/
		printf("%s: test 2. max %d, *length %d, newname[*length - 1] %d.\n", __func__, max, *length, newname[*length - 1]);
		/*ljy--test end*/
        return MATCH_FAILED;
    }
