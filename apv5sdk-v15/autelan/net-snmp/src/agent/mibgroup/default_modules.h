...
config_require(autelan-mib/autelan-sourceFile/wapi/wapiPwlanAp)
config_require(autelan-mib/autelan-sourceFile/wapi/wapiiofunc)
config_require(autelan-mib/autelan-sourceFile/wapi/wapiiwfunc)
config_require(autelan-mib/autelan-sourceFile/wapi/wapicgifunc)
config_require(autelan-mib/autelan-sourceFile/wapi/mii_app)

//11i apart added by zpz-20081013
config_require(autelan-mib/autelan-sourceFile/wapi/11i)
config_require(autelan-mib/autelan-sourceFile/wapi/readKey)
config_require(autelan-mib/autelan-sourceFile/wapi/readRadius)
config_require(autelan-mib/autelan-sourceFile/wapi/wirelessStatus)

//add by piyp 2008-12-25
config_require(autelan-mib/autelan-sourceFile/wapi/syslogService)
config_require(autelan-mib/autelan-sourceFile/wapi/alarmService)
