...
#include <net/route.h>  //cz modified.
...
#define	IP_ROUTEADDR_OFF	10
 ...
 //       long_return =            netsnmp_access_interface_index_find( Lowentry.ipRouteIfIndex.o_bytes); //cz modified
#else
        long_return =
...
Route_Scan_Reload(void)
{
  ...
  //      rt->rt_unit = netsnmp_access_interface_index_find(name); //cz modified
