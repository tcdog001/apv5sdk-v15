...

{
	...
	static char const * optv [] = 
	{
		...
		"e x\techo return frames having ethertype (x) [" OPTSTR (EFSU_ETHERTYPE) "]",
		...
		"l n\trepeat file sequence (n) times [" OPTSTR (EFSU_LOOP) "]",
		"p n\twait (n) seconds between files [" OPTSTR (EFSU_PAUSE) "]",
		"t n\tread timeout is (n) milliseconds [" OPTSTR (CHANNEL_TIMEOUT) "]",
		"v\tverbose messages",
		"w n\twait (n) seconds between loops [" OPTSTR (EFSU_DELAY) "]",
		(char const *) (0)
	};
