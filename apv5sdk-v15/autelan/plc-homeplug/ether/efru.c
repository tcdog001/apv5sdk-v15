...

{
	...
	static char const * optv [] = 
	{
		...
		"e x\tethertype is (x) [" OPTSTR (EFRU_ETHERTYPE) "]",

#if defined (WINPCAP) || defined (LIBPCAP)

		"i n\thost interface is (s) [" OPTSTR (CHANNEL_ETHNUMBER) "]",

#else

		"i s\thost interface is (n) [" OPTSTR (CHANNEL_ETHDEVICE) "]",

#endif

		"q\tsuppress normal output",
		"t n\tread timeout is (n) milliseconds [" OPTSTR (CHANNEL_FOREVER) "]",
