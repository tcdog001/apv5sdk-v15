...
#define PIB_BADVERSION "function %s found bad PIB version in %s", __func__
#define PIB_BADCONTENT "function %s found wrong PIB content in %s", __func__
#define PIB_BADLENGTH "function %s found wrong PIB image length in %s", __func__
#define PIB_BADCHECKSUM "function %s found wrong PIB image checksum in %s", __func__
#define PIB_BADNID "function %s found wrong Preferred NID in %s", __func__
...
signed pibtype (struct _file_ const * pib, flag_t flags);
signed pibseek (struct _file_ const * pib, flag_t flags);
