 ...
 *   different status codes for the same message type and error;
 *
 ...
 *   table size; define MMEPASSFAIL as 0 to suppress the table without 
 *   disturbing other code;
 *
 *   Atheros vendor specific status codes are reused; a given code
