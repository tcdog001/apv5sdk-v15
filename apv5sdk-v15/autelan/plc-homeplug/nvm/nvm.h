...
#define	NVM_HDR_VERSION	"function %s found bad NVM header version in %s module %d", __func__
#define	NVM_HDR_CHECKSUM "function %s found bad NVM header checksum in %s module %d", __func__
#define	NVM_HDR_LINK "function %s found bad NVM header link in %s module %d", __func__
#define	NVM_IMG_CHECKSUM "function %s found bad image checksum in %s module %d", __func__
#define	NVM_HDR_CANTREAD "function %s can't read image header in %s module %d", __func__
#define	NVM_HDR_CANTSAVE "function %s can't save image header in %s module %d", __func__
#define	NVM_IMG_CANTREAD "function %s can't read image in %s module %d", __func__
#define	NVM_IMG_CANTSAVE "function %s can't save image in %s module %d", __func__
...
signed manifest	(void const * memory, uint32_t extent);
...
signed nvmseek1 (struct _file_ const *, struct nvm_header1 *, uint32_t imagetype);
signed nvmseek2 (struct _file_ const *, struct nvm_header2 *, uint32_t imagetype);
