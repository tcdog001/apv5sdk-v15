...
/*====================================================================*
 *
 *   signed chknvm2 (char const * filename, flag_t flags);
 *
...
static signed chknvm2 (char const * filename, flag_t flags) 

{
	...
	if ((extent = lseek (fd, 0, SEEK_END)) == (unsigned)(-1)) 
	{
