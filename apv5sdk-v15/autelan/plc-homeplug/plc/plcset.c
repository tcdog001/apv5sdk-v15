...

{
	...
	static char const * optv [] = 
	{
		...
		"n n\tproperty identifier or version is (n) [" OPTSTR (PLCSET_PROP_VERSION) "]",
		"o n\tproperty option is (n) [" OPTSTR (PLCSET_PROP_OPTION) "]",
		"q\tquiet mode",
		"s x\tsession identifier is (x) [" OPTSTR (PLCSESSION) "]",
