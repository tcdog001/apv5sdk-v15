...

{
	...
	printf (" %20I64d", HTOLE64(transmit->NUMTXPBS_PASS));
	printf (" %20I64d", HTOLE64(transmit->NUMTXPBS_FAIL));

#else

	printf (" %20lld", HTOLE64(transmit->NUMTXPBS_PASS));
	printf (" %20lld", HTOLE64(transmit->NUMTXPBS_FAIL));

#endif

	printf (" %6.2f%%", error_rate (HTOLE64(transmit->NUMTXPBS_PASS), HTOLE64(transmit->NUMTXPBS_FAIL)));
	...
	printf (" %20lld", HTOLE64(transmit->NUMTXMPDU_ACKD));
	printf (" %20lld", HTOLE64(transmit->NUMTXMPDU_FAIL));

#endif

// printf (" %20lld", transmit->NUMTXMPDU_COLL);

	printf (" %6.2f%%", error_rate (HTOLE64(transmit->NUMTXMPDU_ACKD), HTOLE64(transmit->NUMTXMPDU_FAIL)));
	printf ("\n");
	return;
}
...
{
	printf ("    RX");
	printf (" %20lld", HTOLE64(receive->NUMRXPBS_PASS));
	printf (" %20lld", HTOLE64(receive->NUMRXPBS_FAIL));
	printf (" %6.2f%%", error_rate (HTOLE64(receive->NUMRXPBS_PASS), HTOLE64(receive->NUMRXPBS_FAIL)));
	printf (" %20lld", HTOLE64(receive->NUMRXMPDU_ACKD));
	printf (" %20lld", HTOLE64(receive->NUMRXMPDU_FAIL));
	printf (" %6.2f%%", error_rate (HTOLE64(receive->NUMRXMPDU_ACKD), HTOLE64(receive->NUMRXMPDU_FAIL)));
	printf ("\n");
	return;
}
...

{
	...
	while (slot < receive->NUMRXINTERVALS) 
	{
		...
		printf (" %20lld", HTOLE64(interval->NUMRXPBS_PASS));
		printf (" %20lld", HTOLE64(interval->NUMRXPBS_FAIL));
		printf (" %6.2f%%", error_rate (HTOLE64(interval->NUMRXPBS_PASS), HTOLE64(interval->NUMRXPBS_FAIL)));
		printf (" %20lld", HTOLE64(interval->SUMTURBOBER_PASS));
		printf (" %20lld", HTOLE64(interval->SUMTURBOBER_FAIL));
		printf (" %6.2f%%", error_rate (HTOLE64(interval->SUMTURBOBER_PASS), HTOLE64(interval->SUMTURBOBER_FAIL)));
		printf ("\n");
		interval++;
		slot++;
	}
	...
	printf (" %20lld", HTOLE64(receive->NUMRXPBS_FAIL));
	printf (" %6.2f%%", error_rate (HTOLE64(receive->NUMRXPBS_PASS), HTOLE64(receive->NUMRXPBS_FAIL)));
	printf (" %20lld", HTOLE64(receive->SUMTURBOBER_PASS));
	printf (" %20lld", HTOLE64(receive->SUMTURBOBER_FAIL));
	printf (" %6.2f%%", error_rate (HTOLE64(receive->SUMTURBOBER_PASS), HTOLE64(receive->SUMTURBOBER_FAIL)));
