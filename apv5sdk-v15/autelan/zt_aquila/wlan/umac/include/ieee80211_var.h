...
typedef struct ieee80211com {
    ...
    u_int32_t                     ic_stop_transmit;     /*add by zhanghu*/
...
#define IBSS_RSSI_CLASS_MAX 7
    ...
    atomic_t			vap_packet_number;
    atomic_t			vap_packet_number_send;
    unsigned int		vap_packet_max_number;
    unsigned int		every_node_packet_max_number;
    unsigned int		vap_packet_max_number_send;
    unsigned int		every_node_packet_max_number_send;
    u_long				vap_traffic_tick;
    unsigned char		vap_traffic_limit;
    unsigned char		every_node_traffic_limit;
