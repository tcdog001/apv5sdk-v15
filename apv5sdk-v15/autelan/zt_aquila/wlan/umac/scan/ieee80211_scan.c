                       ...
                       scan_request_data_t *request_data)
{
    ...
    if(iwlist_scan_onebyone && vaphandle->iwlist_scanning&& ss->ss_vap->iv_opmode == IEEE80211_M_HOSTAP)
    {
...
static bool scanner_check_endof_scan(ieee80211_scanner_t ss)
{
	...
	/*zhaoyang1 transplant from 717*/
    /*suzhaoyu add start iwlist ath scanning modify PCAPVXN-87*/
    if(iwlist_scan_onebyone && 1 == ss->ss_vap->iwlist_scanning && ss->ss_vap->iv_opmode == IEEE80211_M_HOSTAP)
    {
...
static void scanner_state_foreign_channel_entry(void *context)
{
	...
	/*zhaoyang1 transplant from 717*/
	/*suzhaoyu add start iwlist ath scanning modify PCAPVXN-87*/
	if(iwlist_scan_onebyone&&ss->ss_vap->iwlist_scanning&& ss->ss_vap->iv_opmode == IEEE80211_M_HOSTAP)
	{
