...
static int ath_ni_statistics_rate_for_rx_frame(struct ieee80211_node *ni)
{
...
ath_net80211_rx(ieee80211_handle_t ieee, wbuf_t wbuf, ieee80211_rx_status_t *rx_status, u_int16_t keyix)
{
    ...
    if (IEEE80211_IS_DATA(wh)) {
        ...
        /*Start: Add by zhanghu to statistics of every frame by the rate*/
        ath_ni_statistics_rate_for_rx_frame(ni); 
        
        {
            struct ieee80211_rx_status rs;                
            ath_rxstat2ieee(ic, rx_status, &rs);
            ieee80211_vap_statistics_rate_for_rx_frame(ni->ni_vap, &rs);
        }
        /*End: Add by zhanghu to statistics of every frame by the rate*/
