...
*/
    ...
    */
    ...
    /*Begin: added by zhanghu for stopping recv and send*/
    { ATH_PARAM_STOP_TRANSMIT | ATH_PARAM_SHIFT,
      IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "stop_Trmit"},
    { ATH_PARAM_STOP_TRANSMIT | ATH_PARAM_SHIFT,
      0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "get_stop_Trmit"},
    /*END: added by zhanghu for stopping recv and send*/
