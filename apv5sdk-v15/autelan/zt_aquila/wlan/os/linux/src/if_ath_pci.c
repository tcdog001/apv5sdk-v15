...
ath_pci_probe(struct pci_dev *pdev, const struct pci_device_id *id)
{
     ...
     */
    /*zhaoyang1 transplant from 717*/
    /*Begin:modified by duanmingzhe for fix a bug of can not set mac address in wifi1*/
    //dev->type = ARPHRD_IEEE80211;	
    dev->type = ARPHRD_ETHER;
    /*End:modified by duanmingzhe for fix a bug of can not set mac address in wifi1*/
	/*zhaoyang1 transplant end*/
