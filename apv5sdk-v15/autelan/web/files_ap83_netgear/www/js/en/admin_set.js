...
var	firm_upload="<input type=\"submit\" value=\"Upgrade to thin ap\" onclick=\"return confirm('May take several minutes,Please do not interrupt or turn off power')\">";
...
/***************************/
var	alert_null="Please enter a password!";
var	alert_diff="Password input is inconsistent!";
var	alert_range="Password length of 5-32 characters!";
var	alert_ill="Enter the password for illegal characters!The legal characters include numbers, uppercase and lowercase letters and some special characters (`~ @ # $% ^ & * () _ + - = {} | [] \:"; '<>?,. /).";
