...
//	var gChnlMatrix = new CountryMap();
	...
	var  DispChannelList=function(block,str,id,obj)
	{
		var tmp=str;
		updateChannelInfo(block, tmp);
		DispRatelist(block,tmp);
		setActiveRadioStatus(tmp,id);
	}
	...
	var setActiveRadioStatus = function(tmp,id)
	{
		...
		if ($('cb_'+id)) {
			...
			setActiveMode($('cb_'+id),'WirelessMode1', false);
		}
	}
