...
var winfo_vap_create_alert1=" 已经存在，您是否确定要重新创建？点确定之后 ";
var winfo_vap_create_alert2=" 将重置。";
...
var	wset_associated_bssid="关联的BSSID：";
...
var wset_alert_illchar="含有非法字符，必须为数字0-9";
var wset_alert_range="值超出范围";
var wset_alert_c1213="使信道12、13生效需要重启AP";
var alert_ssid_null="请输入ssid。";
var wset_alert_ssid="请输入正确的ssid！";
var wset_txpower="发射功率：";
var alert_txpower_error="发射功率输入错误。";
var alert_txpower_null="请输入发射功率。";
var alert_bssid_error="BSSID输入错误,BSSID格式以冒号(:)间隔。";
var alert_bssid_null="请输BSSID。";
var wset_staset_wds="Mesh接口配置";
var wset_stastate_wds="Mesh接口状态：";
...
var sec_cert_ca="CA证书：";
var sec_alert_wapi_fail="wapi加密错误，请重试！";
var	sec_alert_p12_fail="p12密码错误，请重试！";
var sec_alert_cert_file="请输入证书文件！";
var sec_p12="p12使能：";
var sec_p12_pass="密码：";
...
var sec_alert_key_phrase="密钥短语长度不能小于8位";
var sec_alert_wepk1="请正确输入WEP键1";
var sec_alert_wepk2="请正确输入WEP键2";
var sec_alert_wepk3="请正确输入WEP键3";
var sec_alert_wepk4="请正确输入WEP键4";
var sec_alert_length="请输入长度正确的密钥";
...
var radius_alert_ill="含有非法字符或者长度大于5";
var radius_alert_range="值超出范围";
var radius_alert_ip="请输入正确的IP地址";
...
var mac_alert_max="最多设置20个MAC过滤";
var mac_alert_atleast="最少要设置一个MAC过滤";

/***************************/
/*  advance_set_language  */
/***************************/
var adv_shortgi="短警戒间隔";
var adv_extoffset="信道扩展方向";
var adv_extoffset_0="不扩展";
var adv_extoffset_1="向下";
var adv_extoffset_2="向上";
...
var adv_alert_illchar=" 含有非法字符，必须为数字0-9。";
var adv_alert_range="值超出范围。";
var adv_must_reboot="如果你选择这个选项，你必须重启AP才能让其生效!";
/***************************/
/*  wds_set_language  */
/***************************/
...
var wds_attention="请确认vap的信道与对方一致";
