...
extern void timer_rem(int id, int isFree);
extern int timer_add(long sec, long usec, void(*hndlr)(void *), void *hndlr_arg);
extern unsigned long info_report_get_current_time();
