...
int wireless_sec_get_wepkey_seq( unsigned int un_vap_num,   char *str_key_seq,unsigned int un_size );
int wireless_sec_set_wepkey_level( unsigned int un_vap_num,  char *str_key_level); 
int wireless_sec_get_wepkey_level( unsigned int un_vap_num,  char *str_key_level,unsigned int un_size ); 
int wireless_sec_set_wepkey( unsigned int un_vap_num, char *str_key_seq, char *str_key_type, char *str_key, int flag );
int wireless_sec_get_wepkey( unsigned int un_vap_num, char *str_key_seq, char *str_key, unsigned int un_size );



int wireless_sec_set_encrypt( unsigned int un_vap_num,  char *str_encrypt,  int flag );
int wireless_sec_get_encrypt( unsigned int un_vap_num,  char *str_encrypt,  unsigned int un_size );
...
int wireless_sec_get_wpakey( unsigned int un_vap_num, char *str_wpakey, unsigned int un_size );
...
int wireless_radius_get_authip( char *str_flag,  char *str_ipaddr,    unsigned int un_size  );
int wireless_radius_set_authport( char *str_flag, char *str_port );
int wireless_radius_get_authport( char *str_flag, char *str_port, unsigned int un_size );
int wireless_radius_set_acctip( char *str_flag,   char *str_ipaddr );
int wireless_radius_get_acctip( char *str_flag, char *str_ipaddr,  unsigned int un_size );
int wireless_radius_set_acctport( char *str_flag,      char *str_port );
int wireless_radius_get_acctport( char *str_flag,  char *str_port,unsigned int un_size );
int wireless_radius_set_sharekey( char *str_flag, char *str_key );                                  
int wireless_radius_get_sharekey( char *str_flag,     char *str_key,    unsigned int un_size );
int wireless_radius_set_asharekey( char *str_flag,   char *str_key ); 
int wireless_radius_get_asharekey( char *str_flag,   char *str_key,   unsigned int un_size );
