...
const struct dhcp_option dhcp_options[] = {
	...
	{"acaddr",      OPTION_IP | OPTION_REQ,                 0x2b},
	...
	{"acaddr189", 	OPTION_IP | OPTION_REQ,      	    	0xBD},
	{"acaddr138", 	OPTION_IP | OPTION_REQ,      	    	0x8A},
...
/* for dhcp option43 */
const struct dhcp_option dhcp_option43[] = {
    /*env name[10]  flags           code*/
    {"acaddr",      OPTION_IP,      0x11},
    {"acaddr",	    OPTION_IP,	0x80},
    {NULL,          0x00,           0x00}
};
