 ...
 */
#define AUTOCONF_TIMESTAMP "2015-07-08 23:02:23 EDT"
...
#define SKIP_GZIP(...)
#undef CONFIG_IPKG
#define ENABLE_IPKG 0
#define USE_IPKG(...)
#define SKIP_IPKG(...) __VA_ARGS__
...
#define USE_NETMSG(...)
#define SKIP_NETMSG(...) __VA_ARGS__
...
#undef CONFIG_FEATURE_SH_IS_SPLASH
#define ENABLE_FEATURE_SH_IS_SPLASH 0
#define USE_FEATURE_SH_IS_SPLASH(...)
#define SKIP_FEATURE_SH_IS_SPLASH(...) __VA_ARGS__
