...
#define MASK_FP_EXCEPTIONS (1 << 10)
#define MASK_FLOAT64 (1 << 11)
...
#define MASK_SINGLE_FLOAT (1 << 20)
#define MASK_SMARTMIPS (1 << 21)
#define MASK_SOFT_FLOAT_ABI (1 << 22)
#define MASK_SPLIT_ADDRESSES (1 << 23)
...
enum opt_code
{
  ...
  OPT_Wnonstd_intrinsics,                    /* -Wnonstd-intrinsics */
