...
enum gt_types_enum {
 gt_ggc_e_20prod_token_parm_item, 
...
#define gt_ggc_m_20prod_token_parm_item(X) do { \
  if (X != NULL) gt_ggc_mx_prod_token_parm_item (X);\
  } while (0)
extern void gt_ggc_mx_prod_token_parm_item (void *);
...
#define gt_ggc_m_12tree_bb_info(X) do { \
  if (X != NULL) gt_ggc_mx_tree_bb_info (X);\
  } while (0)
extern void gt_ggc_mx_tree_bb_info (void *);
...
#define gt_pch_n_20prod_token_parm_item(X) do { \
  if (X != NULL) gt_pch_nx_prod_token_parm_item (X);\
  } while (0)
extern void gt_pch_nx_prod_token_parm_item (void *);
...
#define gt_pch_n_12tree_bb_info(X) do { \
  if (X != NULL) gt_pch_nx_tree_bb_info (X);\
  } while (0)
extern void gt_pch_nx_tree_bb_info (void *);
...
extern void gt_pch_p_20prod_token_parm_item
...
extern void gt_pch_p_18VEC_basic_block_gc
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_12tree_bb_info
    (void *, void *, gt_pointer_operator, void *);
