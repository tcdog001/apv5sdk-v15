/* Type information for treelang/treetree.c.
...
{
  union lang_tree_node * const x = (union lang_tree_node *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_14lang_tree_node, gt_ggc_e_14lang_tree_node))
    {
      switch (TREE_CODE (&((*x)).generic) == IDENTIFIER_NODE)
        {
        case 0:
...
const struct ggc_root_tab gt_ggc_r_gt_treelang_treetree_h[] = {
  {
    &signed_and_unsigned_types[0][0],
    1 * (MAX_BITS_PER_WORD + 1) * (2),
