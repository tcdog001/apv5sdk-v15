...
enum machine_mode
{
  ...
  CCV2mode,                /* config/mips/mips-modes.def:38 */
  CCV4mode,                /* config/mips/mips-modes.def:42 */
  CCDSPmode,               /* config/mips/mips-modes.def:47 */
  ...
  V4QQmode,                /* config/mips/mips-modes.def:32 */
  V2HQmode,                /* config/mips/mips-modes.def:32 */
  V4UQQmode,               /* config/mips/mips-modes.def:33 */
  V2UHQmode,               /* config/mips/mips-modes.def:33 */
  V2HAmode,                /* config/mips/mips-modes.def:34 */
  V2UHAmode,               /* config/mips/mips-modes.def:35 */
  V2SFmode,                /* config/mips/mips-modes.def:29 */
  MAX_MACHINE_MODE,
