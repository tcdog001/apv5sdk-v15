...
{
  struct varpool_node * const x = (struct varpool_node *)x_p;
  if (ggc_test_and_set_mark (x))
    {
...
void
gt_ggc_mx_tree_bb_info (void *x_p)
{
  struct tree_bb_info * const x = (struct tree_bb_info *)x_p;
  if (ggc_test_and_set_mark (x))
    {
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_11VEC_tree_gc ((*x).modified_noreturn_calls);
  ...
  if (ggc_test_and_set_mark (x))
    {
      switch (ann_type ((tree_ann_t)&((*x))))
        ...
        case VAR_ANN:
          ...
          gt_ggc_m_11VEC_tree_gc ((*x).vdecl.subvars);
          break;
        case FUNCTION_ANN:
          break;
        case STMT_ANN:
  ...
  while (x != xlimit)
    {
      ...
      switch (((((*x)).flags & BB_RTL) != 0))
        {
        case 0:
          gt_ggc_m_12tree_bb_info ((*x).il.tree);
          break;
        case 1:
...
{
  struct varpool_node * const x = (struct varpool_node *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_12varpool_node, gt_ggc_e_12varpool_node))
    {
...
void
gt_pch_nx_tree_bb_info (void *x_p)
{
  struct tree_bb_info * const x = (struct tree_bb_info *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_12tree_bb_info, gt_ggc_e_12tree_bb_info))
    {
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9gimple_df, gt_ggc_e_9gimple_df))
    {
      ...
      gt_pch_n_11VEC_tree_gc ((*x).modified_noreturn_calls);
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_10tree_ann_d, gt_ggc_e_10tree_ann_d))
    {
      switch (ann_type ((tree_ann_t)&((*x))))
        ...
        case VAR_ANN:
          ...
          gt_pch_n_11VEC_tree_gc ((*x).vdecl.subvars);
          break;
        case FUNCTION_ANN:
          break;
        case STMT_ANN:
  ...
  while (x != xlimit)
    {
      ...
      switch (((((*x)).flags & BB_RTL) != 0))
        {
        case 0:
          gt_pch_n_12tree_bb_info ((*x).il.tree);
          break;
        case 1:
...
void
gt_pch_p_12tree_bb_info (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct tree_bb_info * const x ATTRIBUTE_UNUSED = (struct tree_bb_info *)x_p;
  if ((void *)(x) == this_obj)
