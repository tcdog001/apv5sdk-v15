...
#define OMP_SECTIONS_SWITCH_CHECK(t)	TREE_CHECK (t, OMP_SECTIONS_SWITCH)
...
#define OMP_ATOMIC_LOAD_CHECK(t)	TREE_CHECK (t, OMP_ATOMIC_LOAD)
#define OMP_ATOMIC_STORE_CHECK(t)	TREE_CHECK (t, OMP_ATOMIC_STORE)
...
#define GIMPLE_MODIFY_STMT_CHECK(t)	TREE_CHECK (t, GIMPLE_MODIFY_STMT)
