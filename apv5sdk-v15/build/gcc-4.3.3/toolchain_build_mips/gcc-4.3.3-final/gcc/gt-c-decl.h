...
gt_ggc_mx_lang_tree_node (void *x_p)
{
  ...
  while (ggc_test_and_set_mark (xlimit))
   xlimit = (TREE_CODE (&(*xlimit).generic) == INTEGER_TYPE ? (union lang_tree_node *) TYPE_NEXT_VARIANT (&(*xlimit).generic) : ((union lang_tree_node *) GENERIC_NEXT (&(*xlimit).generic)));
  while (x != xlimit)
    {
        ...
        case 0:
          switch (tree_node_structure (&((*x).generic)))
            ...
            case TS_PHI_NODE:
              ...
              gt_ggc_m_9tree_node ((*x).generic.phi.chain);
              gt_ggc_m_9tree_node ((*x).generic.phi.result);
              gt_ggc_m_15basic_block_def ((*x).generic.phi.bb);
              {
                size_t i3;
                size_t l3 = (size_t)(((tree)&((*x).generic.phi))->phi.num_args);
                for (i3 = 0; i3 != l3; i3++) {
            ...
            case TS_BINFO:
              ...
              {
                size_t i4;
                size_t l4 = (size_t)(((*x).generic.binfo.base_binfos.base).num);
                for (i4 = 0; i4 != l4; i4++) {
            ...
            case TS_STATEMENT_LIST:
              ...
              break;
            case TS_GIMPLE_STATEMENT:
              gt_ggc_m_10tree_ann_d ((*x).generic.gstmt.base.ann);
              gt_ggc_m_9tree_node ((*x).generic.gstmt.block);
              {
                size_t i5;
                size_t l5 = (size_t)(TREE_CODE_LENGTH (TREE_CODE (&((*x).generic.gstmt))));
                for (i5 = 0; i5 != l5; i5++) {
                  gt_ggc_m_9tree_node ((*x).generic.gstmt.operands[i5]);
                }
              }
              break;
            case TS_VALUE_HANDLE:
              gt_ggc_m_10tree_ann_d ((*x).generic.value_handle.common.base.ann);
            ...
            case TS_STRUCT_FIELD_TAG:
              gt_ggc_m_10tree_ann_d ((*x).generic.sft.common.common.common.base.ann);
            ...
            case TS_OMP_CLAUSE:
              ...
              {
                size_t i6;
                size_t l6 = (size_t)(omp_clause_num_ops[OMP_CLAUSE_CODE ((tree)&((*x).generic.omp_clause))]);
                for (i6 = 0; i6 != l6; i6++) {
                  gt_ggc_m_9tree_node ((*x).generic.omp_clause.ops[i6]);
                }
              }
              break;
      ...
      x = (TREE_CODE (&(*x).generic) == INTEGER_TYPE ? (union lang_tree_node *) TYPE_NEXT_VARIANT (&(*x).generic) : ((union lang_tree_node *) GENERIC_NEXT (&(*x).generic)));
    }
}
        ...
        case 0:
          switch (tree_node_structure (&((*x).generic)))
            ...
            case TS_PHI_NODE:
              ...
              gt_pch_n_9tree_node ((*x).generic.phi.chain);
            ...
            case TS_STATEMENT_LIST:
              ...
              break;
            case TS_GIMPLE_STATEMENT:
              gt_pch_n_10tree_ann_d ((*x).generic.gstmt.base.ann);
              gt_pch_n_9tree_node ((*x).generic.gstmt.block);
              {
                size_t i5;
                size_t l5 = (size_t)(TREE_CODE_LENGTH (TREE_CODE (&((*x).generic.gstmt))));
                for (i5 = 0; i5 != l5; i5++) {
                  gt_pch_n_9tree_node ((*x).generic.gstmt.operands[i5]);
                }
              }
              break;
            case TS_VALUE_HANDLE:
              gt_pch_n_10tree_ann_d ((*x).generic.value_handle.common.base.ann);
            ...
            case TS_MEMORY_TAG:
              ...
              break;
            case TS_STRUCT_FIELD_TAG:
              gt_pch_n_10tree_ann_d ((*x).generic.sft.common.common.common.base.ann);
            ...
            case TS_OMP_CLAUSE:
              ...
              gt_pch_n_9tree_node ((*x).generic.omp_clause.common.type);
              {
                ...
                size_t l6 = (size_t)(omp_clause_num_ops[OMP_CLAUSE_CODE ((tree)&((*x).generic.omp_clause))]);
                for (i6 = 0; i6 != l6; i6++) {
                  gt_pch_n_9tree_node ((*x).generic.omp_clause.ops[i6]);
                }
              }
              break;
            case TS_MEMORY_PARTITION_TAG:
  ...
  switch (TREE_CODE (&((*x)).generic) == IDENTIFIER_NODE)
    ...
    case 0:
      switch (tree_node_structure (&((*x).generic)))
        ...
        case TS_GIMPLE_STATEMENT:
          if ((void *)(x) == this_obj)
            op (&((*x).generic.gstmt.base.ann), cookie);
          if ((void *)(x) == this_obj)
            op (&((*x).generic.gstmt.block), cookie);
          {
            size_t i5;
            size_t l5 = (size_t)(TREE_CODE_LENGTH (TREE_CODE (&((*x).generic.gstmt))));
            for (i5 = 0; i5 != l5; i5++) {
              if ((void *)(x) == this_obj)
                op (&((*x).generic.gstmt.operands[i5]), cookie);
            }
          }
          break;
        case TS_VALUE_HANDLE:
          if ((void *)(x) == this_obj)
            op (&((*x).generic.value_handle.common.base.ann), cookie);
          if ((void *)(x) == this_obj)
        ...
        case TS_STRUCT_FIELD_TAG:
          if ((void *)(x) == this_obj)
            op (&((*x).generic.sft.common.common.common.base.ann), cookie);
          if ((void *)(x) == this_obj)
        ...
        case TS_OMP_CLAUSE:
            ...
            op (&((*x).generic.omp_clause.common.type), cookie);
          {
            ...
            for (i6 = 0; i6 != l6; i6++) {
              if ((void *)(x) == this_obj)
                op (&((*x).generic.omp_clause.ops[i6]), cookie);
            }
          }
          break;
        case TS_MEMORY_PARTITION_TAG:
